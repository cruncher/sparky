...
function n(t){f=!0,a.forEach(u("call",[null,t])),a.clear(),f=void 0}function e(t){if(!a.has(t)){if(f===!0)return void t()
a.add(t),void 0===f&&(f=requestAnimationFrame(n))}}function r(t){a.delete(t),void 0!==f&&f!==!0&&0===a.size&&(cancelAnimationFrame(f),f=void 0)}const o=t.Fn,i=t.dom,u=o.invoke,a=(i.now,new Set),s=[]
var f
t.frame={cue:e,uncue:r,data:s}}(window),function(t){"use strict"
function n(t,n,e){if(!e)return y
var r,o,i,u,a=[]
for(N.lastIndex=0;N.lastIndex<e.length&&(r=N.exec(e));){if(o=r[1],i=n[o]?n[o].tx:t[o],!i)throw new Error('mount:  transform "'+o+'" not found')
...
var e,r,o,i,u=[]
for(N.lastIndex=0;N.lastIndex<n.length&&(e=N.exec(n));){if(r=e[1],o=t[r].ix,!o)throw new Error('mount:  transformers "'+r+'" not found')
e[2]?(i=JSON.parse("["+e[2].replace(/'/g,'"')+"]"),u.unshift(o.apply(null,i))):u.unshift(o)}return x.apply(null,u)}function r(t){I.push(t)}function o(t,n,e,o,i){r(this),this.node=t,this.token=n,this.path=e,this.render=o,this.pipe=i}function i(t,n,e,r,i,u,a){o.call(this,t,n,e,r,a),this.type=i,this.read=u}function u(t,e){t.transform=n(e.transforms,e.transformers,t.pipe),t.originalValue=t.read?t.read():""}function a(t,n){function e(e){function o(t){n(i)}var i=t.shift()
...
t.scope=n
var o,i=!1
return t.render?void(t.listen?(o=f(t,n,e),t.cuer=function e(){if(t.update(),!i){i=!0,r.on("push",function(){E(e)})
var u=k(t.path,n)
void 0===u&&o()}},E(t.cuer),t.listen(o)):(t.cuer=function n(){t.update(),i||(i=!0,r.on("push",function(){E(n)}))},E(t.cuer))):void a(r,t.push)}function f(t,n,r){var o,i
return""===t.path&&console.warn('mount: Cannot listen to path ""'),o=S(t.path,n),i=e(r.transformers,t.pipe),x(function(){return t.read()},i,o)}function c(t){t.input&&t.input.stop(),t.unlisten&&t.unlisten(),t.scope=void 0}function l(t){c(t),t.stop()}const p=t.Fn,d=t.Stream,h=t.frame,m=t.Observable,v=Object.assign,g=p.get,y=p.id,b=p.noop,x=p.pipe,w=p.remove,k=p.getPath,S=p.setPath,E=h.cue,F=h.uncue,P=m.observe
var N=/\|\s*([\w-]+)\s*(?::([^|]+))?/g,A=function(){function t(t,n){if(!t)throw new Error('Sparky: unable to parse transform args "'+n+'"')
...
this.node.removeEventListener(this.type,t),this._listenType=void 0,this._listenFn=void 0}}),t.Struct=o,o.Readable=i,o.setup=u,o.bind=s,o.listen=f,o.unbind=c,o.teardown=l,o.parseParams=A,o.findScope=function(t){return g("scope",I.find(function(n){return n.node===t}))}}(window),function(t){"use strict"
...
e.push(""),r.push(new H(t,o[0],o[2],function(t){e[i]=tt(t),n(e)},o[3]))}function u(t,n,e,r,o){var u=r.rtoken,a=u.lastIndex=0,s=u.exec(n)
if(s){for(var f=[],c=function(t){e(t.join(""))};s;)s.index>a&&f.push(n.slice(a,s.index)),i(t,c,f,o,s),a=u.lastIndex,s=u.exec(n)
n.length>a&&f.push(n.slice(a))}}function a(t,n,e,r){for(var o;o=t.shift();)s(o,n,e,r)}function s(t,n,e,r,o){var i=o!==!1&&n.getAttribute(e.attributePrefix+t)||n.getAttribute(Z[t]||t)
return i&&u(n,i,function(e){n.setAttribute(Z[t]||t,e)},e,r)}function f(t,n){return t in n?function(e){n[t]=!!e.find(r)}:function(e){e.find(r)?n.setAttribute(t,t):n.removeAttribute(t)}}function c(t,n,e,r,o){var i=e.length
e.push(!1),r.push(new H(t,o[0],o[2],function(t){e[i]=t,n(e)},o[3]))}function l(t,n,e,r){var o=n.getAttribute(e.attributePrefix+t),i=o||n.getAttribute(t)
if(i){var u=e.rtoken,a=u.lastIndex=0,s=u.exec(i)
if(s){var l=f(t,n)
o||l(B)
for(var p,d=[];s;)s.index>a&&(p=i.slice(a,s.index),X.test(p)||d.push(p)),c(n,l,d,r,s),a=u.lastIndex,s=u.exec(i)
i.length>a&&(p=i.slice(a),X.test(p)||d.push(p))}}}function p(t,r,o){var i=r.rtoken,u=j.attribute("class",t)
if(u){var a=j.classes(t),s=u.replace(i,function(r,i,u,s,f){var c=""
return o.push(new H(t,r,u,function(t){c&&K.test(c)&&e(a,c),t&&K.test(t)&&n(a,t),c=t},s)),""})
t.setAttribute("class",s)}}function d(t,n,e){var r=L(n.attributePrefix+"value",t)||L("value",t),i=o(r,n)
i&&e.push(new V(t,i[0],i[2],y,"input",k,i[3]))}function h(t,n,e){var r=L(n.attributePrefix+"value",t)||L("value",t),i=o(r,n)
i&&e.push(new V(t,i[0],i[2],g,"input",w,i[3]))}function m(t,n,e){var r=L(n.attributePrefix+"value",t),i=o(r,n)
i&&e.push(new V(t,i[0],i[2],b,"change",S,i[3]))}function v(t,n,e){var r=L(n.attributePrefix+"value",t),i=o(r,n)
...
n.checked=O(n.getAttribute("value"))?t===n.value:t===!0}function x(t){var n=this.node
n.checked=O(n.getAttribute("value"))?t===n.value:t===!0}function w(){var t=this.node
return t.value}function k(){var t=this.node
return t.value?parseFloat(t.value):void 0}function S(){var t=this.node
return O(t.getAttribute("value"))?t.checked?t.value:void 0:t.checked}function E(){var t=this.node
if(t.checked)return O(t.getAttribute("value"))?t.value:t.checked}function F(t,n){t.forEach(function(t){t.render&&$(t,n)})}function P(t){t.forEach(U)}function N(t,n){n=D({},Y,n)
var e=[]
ot(t,n,e)
var r,o=F
return{shift:M,stop:function(){e.forEach(Q)},push:function(t){r!==t&&(r=t,o(e,n),o=P,e.forEach(function(e){J(e,t,n)}))}}}const A=Array.prototype,I=t.Fn,j=t.dom,D=Object.assign,L=j.attribute,T=I.get,q=I.id,O=I.isDefined,B=I.nothing,M=I.noop,R=I.overload,C=I.set,_=I.toType,H=t.Struct,V=H.Readable,$=H.setup,J=H.bind,U=H.unbind,Q=H.teardown,G=H.getScope,z=/\s+/,X=/^\s*$/,K=/\S/,W=/function(?:\s+\w+)?\s*(\([\w,\s]*\))/,Y={attributePrefix:"sparky-",mount:M,transforms:{},transformers:{},rtoken:/(\{\[)\s*(.*?)(?:\s*(\|.*?))?\s*(\]\})/g}
var Z={viewbox:"viewBox"},tt=R(_,{boolean:function(t){return t+""},function:function(t){return(t.name||"function")+(W.exec(t.toString())||[])[1]},number:function(t){return Number.isNaN(t)?"":Number.isFinite(t)?t+"":t<0?"-∞":"∞"},string:q,symbol:function(t){return t.toString()},undefined:function(){return""},object:function(t){return t?JSON.stringify(t):""},default:JSON.stringify})
const nt={1:function(t,n,e){for(var r,o=A.slice.apply(t.childNodes),i=-1;r=o[++i];)n.mount(r,n,e)||ot(r,n,e)
p(t,n,e),l("hidden",t,n,e),a(["id","title","style"],t,n,e),it(t,n,e)},3:function(t,n,e){u(t,t.nodeValue,C("nodeValue",t),n,e)},8:M,9:function(t,n,e){for(var r,o=A.slice.apply(t.childNodes),i=-1;r=o[++i];)n.mount(r,n,e)||ot(r,n,e)},10:M,11:function(t,n,e){for(var r,o=A.slice.apply(t.childNodes),i=-1;r=o[++i];)n.mount(r,n,e)||ot(r,n,e)}},et={a:function(t,n,e){s("href",t,n,e)},button:function(t,n,e){l("disabled",t,n,e)},form:function(t,n,e){s("method",t,n,e),s("action",t,n,e)},fieldset:function(t,n,e){l("disabled",t,n,e)},img:function(t,n,e){s("alt",t,n,e)},input:function(t,n,e){l("disabled",t,n,e),l("required",t,n,e),s("name",t,n,e),ut(t,n,e)},label:function(t,n,e){s("for",t,n,e)},meter:function(t,n,e){a(["min","max","low","high","value"],t,n,e)},option:function(t,n,e){l("disabled",t,n,e),s("value",t,n,e)},output:function(t,n,e){s("for",t,n,e)},progress:function(t,n,e){s(["max","value"],t,n,e)},select:function(t,n,e){l("disabled",t,n,e),l("required",t,n,e),s("name",t,n,e),h(t,n,e)},textarea:function(t,n,e){l("disabled",t,n,e),l("required",t,n,e),s("name",t,n,e),h(t,n,e)},time:function(t,n,e){a(["datetime"],t,n,e)},svg:function(t,n,e){a(["viewbox"],t,n,e)},g:function(t,n,e){a(["transform"],t,n,e)},path:function(t,n,e){a(["d","transform"],t,n,e)},line:function(t,n,e){a(["x1","x2","y1","y2","transform"],t,n,e)},rect:function(t,n,e){a(["x","y","width","height","rx","ry","transform"],t,n,e)},text:function(t,n,e){a(["x","y","dx","dy","text-anchor","transform"],t,n,e)},use:function(t,n,e){a(["href","transform"],t,n,e)},default:M},rt={button:function(t,n,e){s("value",t,n,e,!1)},checkbox:function(t,n,e){s("value",t,n,e,!1),l("checked",t,n,e),m(t,n,e)},date:function(t,n,e){a(["min","max","step"],t,n,e),h(t,n,e)},hidden:function(t,n,e){s("value",t,n,e,!1)},image:function(t,n,e){s("src",t,n,e)},number:function(t,n,e){a(["min","max","step"],t,n,e),d(t,n,e)},radio:function(t,n,e){s("value",t,n,e,!1),l("checked",t,n,e),v(t,n,e)},range:function(t,n,e){a(["min","max","step"],t,n,e),d(t,n,e)},reset:function(t,n,e){s("value",t,n,e,!1)},submit:function(t,n,e){s("value",t,n,e,!1)},time:function(t,n,e){a(["min","max","step"],t,n,e),h(t,n,e)},default:function(t,n,e){h(t,n,e)}},ot=R(T("nodeType"),nt),it=R(j.tag,et),ut=R(T("type"),rt)
N.types=nt,N.tags=et,N.inputs=rt,N.mountAttribute=s,N.mountBoolean=l,N.mountInput=ut,N.mountValueString=h,N.mountValueNumber=d,N.parseParams=H.parseParams,N.getScope=function t(n){var e=G(n)
return void 0===e&&n.parentNode?t(n.parentNode):e},t.mount=N}(window),function(t){t.console&&t.console.log&&console.log("Sparky      - https://github.com/cruncher/sparky")}(window),function(t){"use strict"
function n(t,n){for(var e=[],r=-1;t[++r];)e.push(c(t[r],n))
return{stop:function(){return e.forEach(h("stop",arguments))},push:function(){return e.forEach(h("push",arguments))}}}function e(t){return t.replace(/\//g,"\\/")}function r(t){return a(t)||t}function o(t,u,a){function c(){return k=!1,{fn:y}}function l(){w.attributePrefix=o.attributePrefix,w.transforms=o.transforms,w.transformers=o.transformers,!i||a&&a.suppressLogs||console.groupCollapsed("Sparky:",t),E=n(S,w),g.each(E.push),!i||a&&a.suppressLogs||console.groupEnd()}function p(){var t=y.match(x)
...
var g,y=a&&a.fn||f.attribute(o.attributeFn,h)||"",k=!0,S=this,E=v
this[0]=h,this.length=1,s.call(this,d),g=this.map(r).dedup(),this.interrupt=c,this.continue=p,p()}var i=t.DEBUG,u=t.Fn,a=t.Observable,s=t.Stream,f=t.dom,c=t.mount,l=Object.assign,p=u.deprecate,d=u.getPath,h=u.invoke,m=u.noop,v=u.nothing,g=f.tag,y=f.preventDefault,b=c.parseParams,x=/\s*([-\w]+)(?:\s*:\s*((?:"[^"]*"|'[^']*'|[^\s,]+)(?:\s*,\s*(?:"[^"]*"|'[^']*'|[^\s,]+))*))?/,w={mount:function(t,n,e){var r=f.attribute(o.attributeFn,t)
...
return void 0===o?(console.warn("Sparky.fn.global:path – no object at path "+r[0]),u.of()):u.of(o)},get:function(t,n,e){var r=s.of(),o=m
...
return f.before(t,i),f.remove(t),n.tap(function(n){var e=!!n[r]
...
return console.group("Sparky: run  ",t),console.log("data ",r.data),console.groupEnd("---"),n.tap(e)},scope:u.deprecate(function(t,n,e){return o.fn.find.apply(this,arguments)},"Deprecated Sparky fn scope:path renamed find:path"),ignore:p(function(t,n){console.log(this.interrupt(),t,n)},'Sparky: fn "ignore" renamed "stop".')},transforms:{},MarkerNode:function(t){if(!i)return f.create("text","")
var n=t&&t.getAttribute(o.attributeFn)
return f.create("comment",g(t)+(n?" "+o.attributeFn+'="'+n+'"':""))},getScope:c.getScope}),Object.defineProperties(o,{rtoken:{get:function(){return w.rtoken},set:function(t){w.rtoken=t},enumerable:!0,configurable:!0}}),t.Sparky=o}(window),function(t){function n(t,n){d(t).then(function(e){e&&(p[t]=e,n.push(e))}).catch(function(t){throw t})}var e=t.DEBUG,r=t.axios,o=t.jQuery,i=t.Fn,u=t.Sparky,a=t.Stream,s=Object.assign,f=t.fetch,c=i.get,l=c("data"),p={},d=r?function(t){return r.get(t).then(l)}:o?function(t){return o.get(t).then(l)}:f?function(t){return f(t).then(l)}:function(t){throw new Error('Sparky: no axios, jQuery or fetch found for request "'+t+'"')}
...
p[e]?f.push(p[e]):n(e,f)}),f):p[s]?i.of(p[s]):(n(s,f),f)}})}(window),function(t){"use strict"
...
o(r.fn,{"request-on-submit":function(t,r){var s,f="submit"
return u(f,t).tap(a).each(function(r){var u=i("method",t),a=i("action",t)
...
var i=function(){i=y
var e=l.clone(o)
l.empty(n),l.append(n,e),u&&console.log("Sparky fn=template:",n),t.continue()},a=c.of()
...
var s=l.clone(i)
l.empty(n),l.append(n,s),t.continue()}function o(t,n,e,r,o){var u=c.of()
...
return s=u.getElementById(i),a=w[o][i]=s&&l.fragmentFromHTML(s.innerHTML),n(t,e,r,i,a)}var u=!1,a=t.axios,s=t.jQuery,f=t.Fn,c=t.Stream,l=t.dom,p=t.Sparky,d=t.frame,h=Object.assign,m=d.cue,v=t.fetch,g=f.get,y=f.noop,b=g("data"),x=l.parse("html"),w={"":{"":document}},k=a?function(t,n){return a.get(t).then(b).then(x)}:s?function(t,n){return s.get(t).then(b).then(x)}:v?function(t,n){return v(t).then(b).then(x)}:function(t,n){throw new Error('Sparky: no axios, jQuery or fetch found for request "'+t+'"')}
h(p.fn,{template:function(t,n,r){var i,a,s,f=r[0]
if(/#/.test(f)?(i=f.split("#"),a=i[0]||"",s=i[1]||""):(console.warn('Deprecated: Sparky template:url url should be a url or hash ref, actually an id: "'+f+'"'),a="",s=f),u&&!s)throw new Error("Sparky: "+p.attributePrefix+'fn="template:url" requires a url with a hash ref. "'+f+'"')
var c=this
return c.interrupt(),w[a]?e(c,t,n,a,s):o(c,t,n,a,s)},"template-from":function(t,n,e){var i=e[0],a=this,s=c.of()
if(a.interrupt(),/\$\{([\w._]+)\}/.test(i))return n.each(function(e){var c=!1,l=i.replace(/\$\{([\w._]+)\}/g,function(t,n){var r=f.getPath(n,e)
return void 0===r&&(c=!0),r})
if(c)return void console.log("Sparky: template-from not properly assembled from scope",i,e)
...
return t.on?t.on("push",r):r(),function(){t.off("push",r),o(),y(e)}}var i=!1,u=t.Fn,a=t.dom,s=t.Observable,f=t.Sparky,c=t.frame,l=Array.prototype,p=u.noop,d=a.before,h=a.clone,m=a.remove,v=a.tag,g=c.cue,y=c.uncue,b=s.observe,x=f.MarkerNode,w=Symbol("object")
f.fn.each=function(t,n,u){function a(t){var n=h?p.parentNode.value:void 0
i&&console.log("render: each "+JSON.stringify(t)),e(c,l,t,s),r(p,t,s),h&&void 0!==n&&(p.parentNode.value=n)}var s=[],c=t.cloneNode(!0),l=this.interrupt(),p=x(t),h="option"===v(t)
c.removeAttribute(f.attributeFn),d(t,p),m(t)
