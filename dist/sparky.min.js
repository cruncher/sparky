...
n[2]?(i=JSON.parse("["+n[2].replace(/'/g,'"')+"]"),u.unshift(o.apply(null,i))):u.unshift(o)}return O.apply(null,u)}function i(t,e,n,r){var o=e.length
e.push(""),n.push({token:r[0],path:r[2],pipe:r[3],render:function(n){e[o]=I(n),t(e)}})}function u(t,e,n,r){var o=n.rtoken,u=o.lastIndex=0,a=o.exec(t)
if(!a)return M
...
return{stop:function(){return n.forEach(p("stop",arguments))},push:function(){return n.forEach(p("push",arguments))}}}function n(t){return t.replace(/\//g,"\\/")}function r(t,o,i){function s(){return p=!1,{fn:d}}function f(){b.transforms=r.transforms,b.transformers=r.transformers,F=e(v,b),g.each(F.push)}function l(){var e=d.match(y)
if(!e)return v.continue=h,void f()
var n=r.fn[e[1]]
if(!n)throw new Error('Sparky: fn "'+e[1]+'" not found in Sparky.fn')
var o=e[2]&&JSON.parse("["+e[2].replace(/'/g,'"')+"]")
return d=d.slice(e[0].length),g=n.call(v,t,g,o)||g,p&&l()}if(!r.prototype.isPrototypeOf(this))return new r(t,o,i)
t="string"==typeof t?document.querySelector(n(t)):t
var d=i&&i.fn||c.attribute("data-fn",t)||"",p=!0,v=this,g=this,F=m
this[0]=t,this.length=1,a.call(this,function(t,e){this.shift=function(){var t
if(void 0!==o)return t=u(o),o=void 0,t},this.push=function(){o=arguments[arguments.length-1],t("push")},this.stop=function(){g.stop&&g.stop!==v.stop&&g.stop(),F.stop&&F.stop(),e(o?1:0)}}),this.interrupt=s,this.continue=l,l()}var o=t.DEBUG,i=t.Fn,u=t.Observable,a=t.Stream,c=t.dom,s=t.mount,f=Object.assign,l=i.deprecate,d=i.getPath,p=i.invoke,h=i.noop,m=i.nothing,v=c.tag,g=c.preventDefault,y=/\s*([-\w]+)(?:\s*:\s*((?:"[^"]*"|'[^']*'|[\w-\[\]]*)(?:\s*,\s*(?:"[^"]*"|'[^']*'|[\w-\[\]]*))*))?/,b={mount:function(t){var e=c.attribute("data-fn",t)
if(e){var n=r(t,void 0,{fn:e})
return o&&console.log("mounted:",t,e),n.token=e,n.path="",n}}}
r.prototype=Object.create(a.prototype),f(r,{fn:{scope:function(e,n,r){var o=d(r[0],t)
return o?i.of(d(r[0],t)):(console.warn("Sparky: scope:path – no object at path "+r[0]),i.of())},get:function(t,e,n){return e.map(d(n[0]))},stop:function(t,e){console.log(this.interrupt(),t,e)},ignore:l(function(t,e){console.log(this.interrupt(),t,e)},'Sparky: fn "ignore" renamed "stop".'),prevent:function(t,e,n){t.addEventListener(n[0],g),this.then(function(){t.removeEventListener("submit",g)})},log:function(t,e){function n(e){console.group("Sparky: scope",t),console.log("data ",r.data),console.log("scope",e),console.log("fn   ",r.fn),console.groupEnd("---")}var r=this
...
var e=t&&t.getAttribute("data-fn")
return c.create("comment",v(t)+(e?' data-fn="'+e+'"':""))}}),Object.defineProperties(r,{rtoken:{get:function(){return b.rtoken},set:function(t){b.rtoken=t},enumerable:!0,configurable:!0}}),t.Sparky=r}(this),Sparky.nodeToString=Fn.id,function(t){var e=t.Sparky
...
var e=t.dom,n=t.Sparky,r=e.append,o=e.clone,i=e.empty
n.fn.template=function(t,n,u){var a=u[0],c=e.fragmentFromId(a)
if(!c)throw new Error("Sparky: template "+a+" not found.")
var s=this
return s.interrupt(),n.clone().take(1).each(function(e){var n=o(c)
i(t),r(t,n),s.continue()}),n}}(this),function(t){"use strict"
...
b&&d(b,"",a),e.each(function(t){y(),y=d(t,"",g)}),this.on("then",function(){g.cancel(),y()})}}(this),function(t){"use strict"
