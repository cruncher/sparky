...
function e(t,e,n,r){return r.toString=function(){return/function\s*[\w\d]*\s*\([,\w\d\s]*\)/.exec(n.toString())+" { ["+t+"] }"},Mt&&Object.defineProperty(r,"length",{value:e}),r}function n(t,e){return function(){return console.warn("Deprecation warning: "+e),t.apply(this,arguments)}}function r(){if(!t.console)return e
var e=arguments[arguments.length-1],n=xt.slice.call(arguments,0,arguments.length-1)
return n.push((e.name||"function")+"("),function(){n.push.apply(n,arguments),n.push(")"),console.group.apply(console,n)
var t=e.apply(this,arguments)
return console.groupEnd(),console.log("⬅",t),t}}function o(){}function i(t){return t}function u(){return this}function a(t,e){return e(t)}function c(t,e){return function(){e.apply(this,A(arguments,t))}}function s(t,e){return function(n){return t(e(n))}}function f(){var t=arguments
return function(e){return xt.reduce.call(t,a,e)}}function l(t){var e=new Map
...
return function(e){return 1===arguments.length?r(e):arguments.length===n?t.apply(null,arguments):arguments.length>n?d(t.apply(null,xt.splice.call(arguments,0,n)),arguments):d(r(e),xt.slice.call(arguments,1))}}function h(t){return function(){var e=t.apply(this,arguments)
...
return n&&n.apply(this,I(1,arguments))}}function y(t,e){if(t===e)return!0
if("object"!=typeof t||"object"!=typeof e)return!1
var n=Object.keys(t),r=Object.keys(e)
if(n.length!==r.length)return!1
for(var o=n.length;o--;)if(!y(t[n[o]],e[n[o]]))return!1
return!0}function b(t){return!!t||void 0!==t&&null!==t&&!Number.isNaN(t)}function w(t,e){return t!==e}function x(t){return typeof t}function F(t){return Et.toString.apply(t).slice(8,-1)}function E(t){if(t.toArray)return t.toArray()
var e,n=[],r=t.length
if("number"!=typeof t.length)return n
for(n.length=r,e=0;e<r;e++)n[e]=t[e]
return n}function S(t){return parseInt(t,10)}function T(t){return t.toString()}function k(t,e,n){var r=L(t,function(t){return e(n,t)})
t.splice(r,0,n)}function L(t,e){for(var n=t.length,r=n+n%2,o=0;(r=Math.floor(r/2))&&o+r<=n;)e(t[o+r-1])>=0&&(o+=r,r+=r%2)
return o}function M(t,e){return t.indexOf(e)===-1&&t.push(e),t}function C(t,e){return t.push(e),t}function O(t,e){return t===e?0:t>e?1:-1}function A(t,e){return Array.isArray(e)?e.concat(Array.isArray(t)?t:E(t)):e.concat?e.concat(t):E(e).concat(Array.isArray(t)?t:E(t))}function N(t,e){return e.includes?e.includes(t):e.contains?e.contains(t):xt.includes?xt.includes.call(e,t):xt.indexOf.call(e,t)!==-1}function D(t,e){return e&&e.map?e.map(t):xt.map.call(e,t)}function P(t,e){var n,r
if("function"==typeof e.each)e.each(t)
else for(n=e.length,r=-1;++r<n;)t(e[r])
return e}function j(t,e){return e.filter?e.filter(t):xt.filter.call(e,t)}function q(t){if("number"==typeof t.length)return t[t.length-1]}function B(t,e,n){return n.reduce?n.reduce(t,e):xt.reduce.call(n,t,e)}function I(t,e){if(e.slice)return e.slice(t)
if(e.rest)return e.rest(t)
for(var n=[],r=e.length-t;r--;)n[r]=e[r+t]
return n}function _(t,e){if(e.slice)return e.slice(0,t)
if(e.take)return e.take(t)
for(var n=[],r=t;r--;)n[r]=e[r]
return n}function H(t,e){return xt.find.call(e,t)}function R(t,e,n){for(var r=-1,o=e.length,i=t(n);++r<o&&t(e[r])<=i;);e.splice(r,0,n)}function z(t,e){t.remove&&t.remove(e)
var n=t.indexOf(e)
n!==-1&&t.splice(n,1)}function W(t,e){if(e.split&&"string"!=typeof e)return e.split(t)
...
return e===-1||(n.splice(e,1),!1)},e).concat(n)}function X(t,e){var n=E(t)
return j(function(t){var e=n.indexOf(t)
return e!==-1&&(n.splice(e,1),!0)},e)}function Y(t,e){var n=E(t)
return D(function(t){var e=n.indexOf(t)
return e>-1&&n.splice(e,1),t},e).concat(n)}function K(t){return t.unique?t.unique():B(M,[],t)}function U(t,e){return e.sort?e.sort(t):xt.sort.call(e,t)}function V(t,e){return null===e[t]?void 0:e[t]}function J(t,e,n){return"function"==typeof e.set?e.set(t,n):e[t]=n}function Q(t,e,n){for(var r=n.length,o=-1;++o<r;)if(n[o][t]===e)return n[o]}function G(t,e,n,r){var o=t.exec(e)
if(!o)throw new Error('Fn.getPath(path, object): invalid path "'+e+'"')
var i=o[1],u=o[3]?Q(i,o[2]?o[3]:parseFloat(o[3]),n):n[i]
return r(t,e,u)}function Z(t,e,n){return t.lastIndex===e.length?n:n&&"object"==typeof n?G(t,e,n,Z):void 0}function tt(t,e,n,r){var o=t.exec(e)
if(!o)throw new Error('Fn.getPath(path, object): invalid path "'+e+'"')
var i=o[1]
...
u[i]=o[2]?o[3]:parseFloat(o[3]),n.push(u)}J(i,n,u)}return tt(t,e,u,r)}function et(t,e){return Pt.lastIndex=0,Z(Pt,t,e)}function nt(t,e,n){return Pt.lastIndex=0,tt(Pt,t,e,n)}function rt(t,e){return t+e}function ot(t,e){return e+t}function it(t,e,n){for(var r=-1,o="";o.length<e-n.length;)o+=t[++r%t.length]
...
r>i?s=c:f=c,c=.5*(f-s)+s}return c}function dt(t){return Bt.then(t),!0}function pt(t,e){function n(){var t=o.length
...
return t.on("pull",this.shift)},tap:function(t){return this.shift=bt.compose(Dt(t),this.shift),this},toJSON:function(){return this.reduce(C,[])},toString:function(){return this.reduce(rt,"")},process:n(function(t){return t(this)},".process() is deprecated"),last:n(function(){var t=this
...
throw new Error("Fn: from(object) object is not a list of a known kind (array, functor, stream, iterator).")},Timer:pt,nothing:kt,id:i,noop:o,self:u,cache:l,compose:s,curry:p,choose:g,flip:m,once:h,overload:p(v),pipe:f,throttle:ht,wait:mt,equals:p(y),is:p(At),isDefined:b,isIn:p(Nt,!0),isNot:p(w),and:p(function(t,e){return!(!t||!e)}),not:function(t){return!t},or:p(function(t,e){return t||e}),xor:p(function(t,e){return(t||e)&&!!t!=!!e}),isGreater:p(function(t,e){return e>t}),by:p(function(t,e,n){return O(e[t],n[t])},!0),byGreater:p(O),byAlphabet:p(function(t,e){return St.localeCompare.call(t,e)}),toType:x,toClass:F,toArray:E,toString:T,toInt:S,toFloat:parseFloat,toPlainText:function(t){return t.normalize("NFD").replace(/[\u0300-\u036f]/g,"")},toStringType:function(t,e){return function(n){for(var r=e.length;r--;)if(t[e[r]].test(n))return e[r]
try{return JSON.parse(n),"json"}catch(t){}return"string"}}(Ot,["url","date","email","float","int"]),concat:p(A,!0),contains:p(N,!0),diff:p($,!0),each:p(P,!0),filter:p(j,!0),find:p(H,!0),insert:p(R,!0),intersect:p(X,!0),last:q,latest:gt,map:p(D,!0),tap:p(Dt),reduce:p(B,!0),remove:p(z,!0),rest:p(I,!0),sort:p(U,!0),split:p(W,!0),take:p(_,!0),unite:p(Y,!0),unique:K,assign:p(Tt,!0,2),get:p(V,!0),set:p(J,!0),getPath:p(et,!0),setPath:p(nt,!0),invoke:p(function(t,e,n){return n[t].apply(n,e)},!0),add:p(function(t,e){return e+t}),multiply:p(function(t,e){return e*t}),mod:p(function(t,e){return e%t}),min:p(function(t,e){return t>e?e:t}),max:p(function(t,e){return t<e?e:t}),pow:p(function(t,e){return Math.pow(e,t)}),exp:p(function(t,e){return Math.pow(t,e)}),log:p(function(t,e){return Math.log(e)/Math.log(t)}),root:p(function(t,e){return Math.pow(e,1/t)}),gcd:p(at),lcm:p(ct),todB:function(t){return 20*Math.log10(t)},toLevel:function(t){return Math.pow(2,t/6)},toRad:function(t){return t/Lt},toDeg:function(t){return t*Lt},factorise:function(t,e){var n=at(t,e)
...
var n,r=this,i=new Promise(function(i,c){function s(){r.status="done",l=M}function f(t,e){delete r[L],t?l=new a(l,t,s):s(),i(e)}var l
n=function(){var i=u(r)
return l=new t(i,f,e),g&&o(l),l.stop||(l.stop=E),n=function(){return l},l}})
this[L]={},this.push=function(){var t=n()
...
return t.value=void 0===n?F(e):n}function l(t,e,n,r){var o=this
...
this._notify=t,this._stop=e,this._sources=n,this._values=o,this._buffer=i,this._i=0,this._update=r,x(function(e){o.push.apply(o,k(e)),e.on("push",r),e.on("push",t)},n)}function p(t){var n=this,r=[],o=[]
...
this.cancel=n.cancel||E,this.end=e,this.id=i(r)}var g=!1,y=t.Fn,b=Array.prototype,w=Object.assign,x=(y.curry,y.each),F=y.latest,E=y.noop,S=y.now,T=(y.nothing,y.rest,y.throttle,y.Timer),k=y.toArray,L=Symbol("events"),M={shift:E,push:E,start:E,stop:E}
w(a.prototype,M,{shift:function(){return--this.n<1&&this.done(),this.source.shift()}}),w(s.prototype,{shift:function(){var t=this._buffer,e=this._notify
...
x(function(e){var n=e.source,r=e.listen
...
x(function(e){e.off("push",r),e.off("push",t)},e),n(values.length+buffer.length)}}),c.Merge=function(t,e){var n=arguments
...
var C={now:S,request:requestAnimationFrame.bind(t),cancel:cancelAnimationFrame.bind(t)}
...
return t="number"==typeof t?new T(t):t instanceof c?new p(t):t?t:C,new c(function(e,n){return new m(e,n,t)})},w(v.prototype,{shift:function(){var t=this.value
return this.value=void 0,t},stop:function(){var t=this.cancel
t(this.id),this.end()}}),c.clock=function(t){var e="number"==typeof t?new T(t):t||C
...
return y.prototype.each.apply(n,e),this.on("push",function(){y.prototype.each.apply(n,e)})},pipe:function(t){return this.each(t.push),y.prototype.pipe.apply(this,arguments)},on:function(t,e){var n=this[L]
if(!n)return this
var r=n[t]||(n[t]=[])
return r.push(e),this},off:function(t,e){var n=this[L]
if(!n)return this
...
function e(){}function n(t){return t&&t.hasOwnProperty("length")&&"number"==typeof t.length}function r(e){return e&&!v(e)&&!F.prototype.isPrototypeOf(e)&&!(e instanceof Date)&&!(e instanceof RegExp)&&!(e instanceof Map)&&!(e instanceof WeakMap)&&!(e instanceof Set)&&!(!!t.WeakSet&&e instanceof WeakSet)&&!ArrayBuffer.isView(e)}function o(t,e){return t[w][e]||(t[w][e]=[])}function i(t,e){var n=t.indexOf(e)
t.splice(n,1)}function u(t,e,n){if(t)for(var r=-1;t[++r];)t[r](e,n)}function a(t,n){return t!==n.value&&(n.value=t,n(t)),e}function c(t,e){var n=o(t,x),r=e.value
return n.push(e),t!==e.value&&(e.value=t,e(t,{index:0,removed:r?r:E,added:t})),function(){i(n,e)}}function s(t,n,r,o,i){function u(t){return t[n]===r}function a(t){var e=t&&g.find.call(t,u)
s(),s=d(e,o,i)}var s=e,f=c(t,a)
return function(){s(),f()}}function f(t,e,n,r,o){function i(t){return t[e]===n}var u=t&&g.find.call(t,i)
return d(p(u)||u,r,o)}function l(t,e,n,r){return d(p(t[e])||t[e],n,r)}function d(t,e,n){if(!e.length)return t&&t[b]&&t[w]?c(t,n):a(t,n)
if(!t||"object"!=typeof t)return a(void 0,n)
S.lastIndex=0
var r=S.exec(e)
if(!r)throw new Error('Observable: invalid path "'+e+'"')
var o=r[1],i=r[3]&&(r[2]?r[3]:parseFloat(r[3]))
return e=e.slice(S.lastIndex),t[b]?i?s(t,o,i,e,n):k(t,o,e,n):i?f(t,o,i,e,n):l(t,o,e,n)}function p(t){return t?t[b]?t[b]:r(t)?T(t):void 0:void 0}var h=Object.assign,m=Object.defineProperty,v=Object.isFrozen,g=(Object.getPrototypeOf,Array.prototype),y=Symbol("original"),b=Symbol("observable"),w=Symbol("observers"),x=Symbol("update"),F=t.EventTarget||t.Node,E=Object.freeze([]),S=/\[?([-\w]+)(?:=(['"])?([-\w]+)\2)?\]?\.?/g,T=t.Proxy?function(){function t(t,e,n){var r=t[e]
return"symbol"==typeof e?r:p(r)||r}var e={get:t,set:function(t,e,n,r){if("symbol"==typeof e)return t[e]=n,!0
var o=t[e]
if(o===n)return!0
var i,a=t[w]
if("length"===e){if(n>=t.length)return!0
for(i={index:n,removed:g.splice.call(t,n),added:E};--o>=n;)u(a[o],void 0)}else if(+e%1===0)if(e=+e,void 0===n){if(!(e<t.length))return!0
i={index:e,removed:g.splice.call(t,e,1),added:E},n=t[e]}else i={index:e,removed:g.splice.call(t,e,1,n),added:[n]}
else t[e]=n
return u(a[e],p(n)||n),u(a[x],r,i),!0}},r={get:t,set:function(t,e,n,r){var o=t[e]
if(o===n)return!0
var i=t[w],a={name:e,removed:t[e],added:n}
return t[e]=n,u(i[e],p(n)||n),u(i[x],r,a),!0}}
return function(t){var o=new Proxy(t,n(t)?e:r)
return m(t,w,{value:{}}),m(t,b,{value:o}),o}}():function(){function t(t){this[b]=this,this[y]=t,this[w]=t[w],h(this,t),this.length=t.length}return m(t.prototype,"length",{set:function(t){var e=this[y]
if(!(t>=e.length)){for(;--e.length>t;)this[e.length]=void 0
this[e.length]=void 0,notify(this,"")}},get:function(){return this[y].length},configurable:!0}),h(t.prototype,{filter:function(){return g.filter.apply(this[y],arguments)},find:function(){return g.find.apply(this[y],arguments)},map:function(){return g.map.apply(this[y],arguments)},reduce:function(){return g.reduce.apply(this[y],arguments)},concat:function(){return g.concat.apply(this[y],arguments)},slice:function(){return g.slice.apply(this[y],arguments)},some:function(){return g.some.apply(this[y],arguments)},indexOf:function(){return g.indexOf.apply(this[y],arguments)},forEach:function(){return g.forEach.apply(this[y],arguments)},toJSON:function(){return this[y]},sort:function(){return g.sort.apply(this[y],arguments),h(this,array),this.length=array.length,notify(this,""),this},push:function(){var t=this[y],e=g.push.apply(t,arguments)
return h(this,t),this.length=t.length,console.log("PUSH",JSON.stringify(arguments)),notify(this,""),e},pop:function(){var t=this[y],e=g.pop.apply(t,arguments)
return h(this,t),this.length=t.length,notify(this,""),e},shift:function(){var t=this[y],e=g.shift.apply(t,arguments)
return h(this,t),this.length=t.length,notify(this,""),e},splice:function(){var t=this[y],e=g.splice.apply(t,arguments)
return h(this,t),this.length=t.length,notify(this,""),e}}),function(e){var r
return n(e)?(m(e,w,{value:{}}),r=n(e)?new t(e):e):r=e,m(e,b,{value:r}),r}}(),k=t.Proxy?function(t,n,r,u){function a(t){s(),s=d(t,r,u)}var c=o(t,n),s=e
return c.push(a),a(t[n]),function(){s(),i(c,a)}}:function(n,r,o,i){function u(t){a(),a=d(t,o,i)}var a=e,c=t.observe(n[b]||n,r,u)
return u(n[r]),function(){a(),c()}}
p.isObservable=r,p.notify=function(t,e){var n=t[w]
u(n[e],t[b]),u(n[x],t)},p.observe=function(t,e,n){return d(p(t)||t,e+"",n)},p.filter=function(t,e){var n=p([])
return p.observe(e,"",function(){var r=e.filter(t)
h(n,r),n.length=r.length}),n},p.map=function(t,e){var n=p([])
return p.observe(e,"",function(r){var o=e.map(t)
h(n,o),n.length=o.length}),n},t.Observable=p}(this),function(t){"use strict"
...
return"string"==typeof arguments[1]?(n.innerHTML=arguments[1],e=arguments[2]):e=arguments[1],e&&i(n,e),n}function c(t){return zt[t.nodeType]}function s(t){return 1===t.nodeType}function f(t){return 3===t.nodeType}function l(t){return 8===t.nodeType}function d(t){return 11===t.nodeType}function p(e){var r=t.location
...
t.id=e}return e}function m(t){return t.tagName&&t.tagName.toLowerCase()}function v(t,e){return e.getAttribute&&e.getAttribute(t)||void 0}function g(t,e){t instanceof bt?t.setAttribute("class",e):t.className=e}function y(t){return t.classList||new o(t,vt.attribute("class"),g)}function b(t,e){y(e).add(t)}function w(t,e){y(e).remove(t)}function x(t,e){var n=y(e)
n.add(t),requestAnimationFrame(function(){n.remove(t)})}function F(t){return r(t.children||t.querySelectorAll("*"))}function E(t,e){return e=e||document,r(e.querySelectorAll(t))}function S(t,e){return e.contains?e.contains(t):!!t.parentNode&&(t.parentNode===e||S(t.parentNode,e))}function T(t,e){return e.matches?e.matches(t):e.matchesSelector?e.matchesSelector(t):e.webkitMatchesSelector?e.webkitMatchesSelector(t):e.mozMatchesSelector?e.mozMatchesSelector(t):e.msMatchesSelector?e.msMatchesSelector(t):e.oMatchesSelector?e.oMatchesSelector(t):m(e)===t}function k(t,e){var n=arguments[2]
if(e&&e!==document&&e!==n&&11!==e.nodeType)return e=e.correspondingUseElement||e,T(t,e)?e:k(t,e.parentNode,n)}function L(t){return t.nextElementSibling||void 0}function M(t){return t.previousElementSibling||void 0}function C(t,e){return t.appendChild(e),t}function O(t,e){if(e instanceof yt||e instanceof bt)return C(t,e),e
if(e.length){var n=e.reduce?e:qt.slice.call(e)
return n.reduce(C,t),e}}function A(t){for(;t.lastChild;)t.removeChild(t.lastChild)}function N(t){t.parentNode&&t.parentNode.removeChild(t)}function D(t){t instanceof yt||t instanceof bt?N(t):qt.forEach.call(t,N)}function P(t,e){t.parentNode&&t.parentNode.insertBefore(e,t)}function j(t,e){t.parentNode&&t.parentNode.insertBefore(e,t.nextSibling)}function q(t,e){return P(t,e),D(t),t}function B(t){return t.split("(")[1].split(")")[0].split(/\s*,\s*/)}function I(e,n){return t.getComputedStyle?t.getComputedStyle(n,null).getPropertyValue(e):0}function _(e){var n=document.body,r=document.documentElement,o=e.getBoundingClientRect(),i=t.pageXOffset||r.scrollLeft||n.scrollLeft,u=r.clientLeft||n.clientLeft||0
...
return o.top+i-u}function R(){return{left:0,top:0,width:t.innerWidth,height:t.innerHeight}}function z(e){return e===t?R():e.getClientRects()[0]}function W(t){return t.getBoundingClientRect()}function $(t){var e=z(t)
return[e.left,e.top]}function X(t,e){var n=z(t),r=z(e)
return[r.left-n.left,r.top-n.top]}function Y(t,e){var n=Ft({},Vt,e),r=new wt(t,n)
return e&&(delete e.detail,Ft(r,e)),r}function K(t){t.preventDefault()}function U(t){return 1===t.which&&!t.ctrlKey&&!t.altKey&&!t.shiftKey}function V(t){return Qt[t.keyCode]}function J(t,n,r,o){n=n.split(It)
for(var i,u,a=t[Jt]||(t[Jt]={}),c=e(r,o),s=-1;s++<n.length;)u=n[s],i=a[u]||(a[u]=[]),i.push([r,c]),t.addEventListener(u,c)
return t}function Q(t,e,n){e=e.split(It)
var r,o,i,u=t[Jt]
if(!u)return t
for(var a=-1;a++<e.length;)if(r=e[a],o=u[r])for(i=o.length;i--;)o[i][0]===n&&(t.removeEventListener(r,o[i][1]),o.splice(i,1))
return t}function G(t,e,n){var r=Y(e,n)
...
t=Ht.transitionend}J(n,t,Z,e)}function et(t,e){return function(n){var r=k(t,n.target,n.currentTarget)
r&&(n.delegateTarget=r,e(n,r),n.delegateTarget=void 0)}}function nt(t,e){return t=t.split(It),new xt(function(n,r){function o(t){i.push(t),n("push")}var i=[]
return t.forEach(function(t){e.addEventListener(t,o)}),{shift:function(){return i.shift()},stop:function(){t.forEach(function(t){e.removeEventListener(t,o)}),r(i.length)}}})}function rt(t){function e(){var e=vt.query("[tabindex], a, input, textarea, button",t)[0]
e&&e.focus()}function n(n){t.contains(n.target)||(e(),n.preventDefault(),n.stopPropagation())}Gt()
var r=document.activeElement||document.body
return document.addEventListener("focus",n,!0),Pt(e),Gt=function(){Gt=Ct,document.removeEventListener("focus",n,!0),Pt(function(){r.focus()})}}function ot(t){if(t.domFragmentFromChildren)return t.domFragmentFromChildren
var e=a("fragment")
...
var n=m(e)
return"template"!==n||Ht.template||D(e),"template"===n?ut(e):"script"===n?it(e.innerHTML,v("data-parent-tag",e)):ot(e)}function ct(e,n){if(n){var r,o=Zt[e]
...
return r}}function st(){return Xt||(Xt=parseFloat(I("font-size",document.documentElement),10))}function ft(t,e){function n(i){var u=(i-r)/(1e3*t)
u<1?(u>0&&e(u),o=requestAnimationFrame(n)):e(1)}var r=performance.now(),o=requestAnimationFrame(n)
return function(){cancelAnimationFrame(o)}}function lt(t,e,n,r,o){return ft(t,At(e,kt(r[n],o),Dt(n,r)))}function dt(t){var e,n,r=.6,o=Nt(2)
"number"==typeof t?(e=!1,n=t):(e=t[0],n=t[1])
var i=e!==!1&&kt(vt.view.scrollLeft,e),u=kt(vt.view.scrollTop,n)
return ft(r,At(o,function(t){e!==!1&&(vt.view.scrollLeft=i(t)),vt.view.scrollTop=u(t)}))}function pt(t){return t.scrollTop/(t.scrollHeight-t.clientHeight)}function ht(t){t=t||document.documentElement
...
var e=t.scrollLeft,n=t.scrollTop
t.style.overflow="",n&&(t.scrollTop=n),e&&(t.scrollLeft=e)}function vt(t){return E(t,document)}var gt=t.Fn,yt=t.Node,bt=t.SVGElement,wt=t.CustomEvent,xt=t.Stream,Ft=Object.assign,Et=Object.defineProperties,St=gt.cache,Tt=(gt.compose,gt.curry),kt=gt.denormalise,Lt=gt.deprecate,Mt=gt.id,Ct=gt.noop,Ot=gt.overload,At=gt.pipe,Nt=gt.pow,Dt=gt.set,Pt=gt.requestTick,jt=gt.toType,qt=Array.prototype,Bt="http://www.w3.org/2000/svg",It=/\s+/,_t=/px$/,Ht=Et({},{inputEventsWhileDisabled:{get:St(function(){var t=document.createElement("input"),e=Y("featuretest"),n=!1
return C(document.body,t),t.disabled=!0,t.addEventListener("featuretest",function(t){n=!0}),t.dispatchEvent(e),N(t),n}),enumerable:!0},template:{get:St(function(){return"content"in document.createElement("template")}),enumerable:!0},textareaPlaceholderSet:{get:St(function(){var t=document.createElement("textarea")
...
o.prototype={add:function(){for(var t=arguments.length,e=this.get(this.node),n=e?e.trim().split(It):[];t--;)n.indexOf(arguments[t])===-1&&n.push(arguments[t])
this.set(this.node,n.join(" "))},remove:function(){for(var t,e=arguments.length,n=this.get(this.node),r=n?n.trim().split(It):[];e--;)t=r.indexOf(arguments[e]),t!==-1&&r.splice(t,1)
this.set(this.node,r.join(" "))},contains:function(t){var e=this.get(this.node),n=e?e.trim().split(It):[]
return n.indexOf(t)!==-1}}
var Rt=document.createElement("div"),zt={1:"element",3:"text",8:"comment",9:"document",10:"doctype",11:"fragment"},Wt=["circle","ellipse","g","line","rect","use","path","polygon","polyline","svg"],$t={text:function(t){return document.createTextNode(t||"")},comment:function(t){return document.createComment(t||"")},fragment:function(t){var e=document.createDocumentFragment()
return t&&(Rt.innerHTML=t,O(e,Rt.childNodes),Rt.innerHTML=""),e}}
Wt.forEach(function(t){$t[t]=function(e){var n=document.createElementNS(Bt,t)
return e&&u(n,e),n}})
var Xt,Yt=Ht.textareaPlaceholderSet?function(t){return t.cloneNode(!0)}:function(t){var e,n=t.cloneNode(!0),r=vt.query("textarea",t),o=r.length
if(o)for(e=vt.query("textarea",n);o--;)e[o].value=r[o].value
return n},Kt={"transform:translateX":function(t){var e=I("transform",t)
if(!e||"none"===e)return 0
var n=B(e)
return parseFloat(n[4])},"transform:translateY":function(t){var e=I("transform",t)
if(!e||"none"===e)return 0
var n=B(e)
return parseFloat(n[5])},"transform:scale":function(t){var e=I("transform",t)
if(!e||"none"===e)return 0
var n=B(e),r=parseFloat(n[0]),o=parseFloat(n[1])
return Math.sqrt(r*r+o*o)},"transform:rotate":function(t){var e=I("transform",t)
if(!e||"none"===e)return 0
var n=B(e),r=parseFloat(n[0]),o=parseFloat(n[1])
...
return function(t){return r[t]||(r[t]=e(t))}}(["Khtml","O","Moz","Webkit","ms"]),Vt={bubbles:!0},Jt=Symbol("events"),Qt={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",27:"escape",32:"space",33:"pageup",34:"pagedown",35:"pageright",36:"pageleft",37:"left",38:"up",39:"right",40:"down",46:"delete",48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",65:"a",66:"b",67:"c",68:"d",69:"e",70:"f",71:"g",72:"h",73:"i",74:"j",75:"k",76:"l",77:"m",78:"n",79:"o",80:"p",81:"q",82:"r",83:"s",84:"t",85:"u",86:"v",87:"w",88:"x",89:"y",90:"z",91:"cmd",93:"cmd",186:";",187:"=",188:",",189:"-",190:".",191:"/",219:"[",220:"\\",221:"]",222:"'",224:"cmd"},Gt=Ct,Zt={xml:"application/xml",html:"text/html",svg:"image/svg+xml"},te=function(){var t=document.createElement("pre"),e=document.createTextNode("")
return t.appendChild(e),function(n){return e.textContent=n,t.innerHTML}}(),ee=/(\d*\.?\d+)r?em/,ne=Ot(jt,{number:Mt,string:function(t){var e,n
...
Ft(vt,{ready:oe.then.bind(oe),get:function(t){return document.getElementById(t)||void 0},find:gt.deprecate(function(t){return document.getElementById(t)||void 0},"dom.find(id) is now dom.get(id)"),query:Tt(E,!0),closest:Tt(k,!0),contains:Tt(S,!0),matches:Tt(T,!0),children:F,next:L,previous:M,assign:Tt(i,!0),create:a,clone:Yt,identify:h,append:Tt(O,!0),before:Tt(P,!0),after:Tt(j,!0),replace:Tt(q,!0),empty:A,remove:D,isElementNode:s,isTextNode:f,isCommentNode:l,isFragmentNode:d,isInternalLink:p,type:c,tag:m,attribute:Tt(v,!0),classes:y,addClass:Tt(b,!0),removeClass:Tt(w,!0),flashClass:Tt(x,!0),box:z,bounds:W,rectangle:Lt(z,"dom.rectangle(node) now dom.box(node)"),offset:Tt(X,!0),position:$,prefix:Ut,style:Tt(function(t,e){if(Kt[t])return Kt[t](e)
var n=I(t,e)
return"string"==typeof n&&_t.test(n)?parseFloat(n):n},!0),toPx:ne,toRem:re,viewportLeft:_,viewportTop:H,fragmentFromTemplate:ut,fragmentFromChildren:ot,fragmentFromHTML:it,fragmentFromId:at,escape:te,parse:Tt(ct),Event:Y,delegate:et,isPrimaryButton:U,preventDefault:K,toKey:V,trapFocus:rt,trap:gt.deprecate(rt,"dom.trap() is now dom.trapFocus()"),events:{on:J,off:Q,trigger:G},on:gt.deprecate(Tt(nt,!0),"dom.on() is now dom.event()"),trigger:Tt(function(t,e){return G(e,t),e},!0),event:Tt(nt,!0),transition:Tt(ft,!0),schedule:Lt(ft,"dom: .schedule() is now .transition()"),animate:Tt(lt,!0),animateScroll:dt,scrollTo:Lt(dt,"scrollTo(px, node) renamed to animateScroll(px)"),scrollRatio:pt,disableScroll:ht,enableScroll:mt,requestEvent:tt,requestFrame:requestAnimationFrame.bind(null),requestFrameN:Tt(Lt(function(t,e){!function n(){return requestAnimationFrame(--t?n:e)}()},"requestFrameN() will be removed soon"),!0),features:Ht,safe:Et({left:0},{right:{get:function(){return t.innerWidth},enumerable:!0,configurable:!0},top:{get:function(){return I("padding-top",document.body)},enumerable:!0,configurable:!0},bottom:{get:function(){return t.innerHeight},enumerable:!0,configurable:!0}})}),Et(vt,{root:{value:document.documentElement,enumerable:!0},head:{value:document.head,enumerable:!0},body:{get:function(){return document.body},enumerable:!0},view:{get:function(){return document.scrollingElement},enumerable:!0},viewport:{get:function(){return console.warn("Deprecated: dom.viewport is now dom.view"),document.scrollingElement},enumerable:!0}}),t.dom=vt}(this),function(t){function e(t,e){e=e||r
...
if(!e)throw new Error('DOM: element id="'+t+'" is not in the DOM.')
var n=m(e)
return"template"!==n||Ht.template||D(e),"template"===n?ut(e):"script"===n?it(e.innerHTML,v("data-parent-tag",e)):ot(e)}function ct(e,n){var r,o=Zt[e]
try{r=(new t.DOMParser).parseFromString(n,o)}catch(t){r=void 0}if(!r||r.getElementsByTagName("parsererror").length)throw new Error("dom: Invalid XML: "+n)
return r}function st(){return Xt||(Xt=parseFloat(I("font-size",document.documentElement),10))}function ft(t,e){function n(i){var u=(i-r)/(1e3*t)
u<1?(u>0&&e(u),o=requestAnimationFrame(n)):e(1)}var r=performance.now(),o=requestAnimationFrame(n)
return function(){cancelAnimationFrame(o)}}function lt(t,e,n,r,o){return ft(t,At(e,kt(r[n],o),Dt(n,r)))}function dt(t){return lt(.6,Nt(2),"scrollTop",vt.view,ne(t))}function pt(t){return t.scrollTop/(t.scrollHeight-t.clientHeight)}function ht(t){t=t||document.documentElement
var e=t.scrollLeft,n=t.scrollTop
t.style.overflow="hidden",n&&(t.scrollTop=n),e&&(t.scrollLeft=e)}function mt(t){t=t||document.documentElement
var e=t.scrollLeft,n=t.scrollTop
t.style.overflow="",n&&(t.scrollTop=n),e&&(t.scrollLeft=e)}function vt(t){return E(t,document)}var gt=t.Fn,yt=t.Node,bt=t.SVGElement,wt=t.CustomEvent,xt=t.Stream,Ft=Object.assign,Et=Object.defineProperties,St=gt.cache,Tt=(gt.compose,gt.curry),kt=gt.denormalise,Lt=gt.deprecate,Mt=gt.id,Ct=gt.noop,Ot=gt.overload,At=gt.pipe,Nt=gt.pow,Dt=gt.set,Pt=gt.requestTick,jt=gt.toType,qt=Array.prototype,Bt="http://www.w3.org/2000/svg",It=/\s+/,_t=/px$/,Ht=Et({},{inputEventsWhileDisabled:{get:St(function(){var t=document.createElement("input"),e=Y("featuretest"),n=!1
...
e.active||(e.active=!0,this.preventDefault(),m&&console.log("[activate] default | target:",this.target.id,"data:",e),y(e.node).add(k),t=o(e),t&&t.forEach(function(t){g.classes(t).add(L)}))}function u(){var t,e=this.data||r(this.target)
e.active&&(e.active=!1,this.preventDefault(),m&&console.log("[deactivate] default | target:",this.target.id,"data:",e),y(e.node).remove(k),t=o(e),t&&t.forEach(function(t){g.classes(t).remove(L)}))}function a(t){var e=g.create("div",{class:"dialog-layer layer"}),n=g.create("div",{class:"dialog popable"}),r=g.create("button",{class:"close-thumb thumb"})
return g.append(n,t),g.append(e,n),g.append(e,r),g.append(document.body,e),n}function c(t){"mousedown"===t.type&&w(t.currentTarget,"click",function t(e){x(e.currentTarget,"click",t),e.preventDefault()})}function s(t){return!!t.defaultPrevented||(!g.isPrimaryButton(t)||(("keydown"===t.type||"keyup"===t.type)&&13!==t.keyCode||void 0))}function f(t,e){t.preventDefault(),"mousedown"===t.type&&c(t),F(e,"dom-activate",{relatedTarget:t.currentTarget})}function l(t){return(S(t.hash)?t.hash:t.getAttribute("href")).substring(1)}function d(t,e){var n=document.getElementById(e)
if(n){g.classes(n)
g.activeMatchers.find(N(n))?f(t,n):g.activateOther&&g.activateOther(n)}}function p(t){if(!s(t)&&(!t.delegateTarget.hostname||g.isInternalLink(t.delegateTarget))){var e=l(t.delegateTarget)
e&&d(t,e)}}function h(t){var e=t.delegateTarget.target
if(!s(t)&&q[e])return q[e](t)}var m=!1,v=t.Fn,g=t.dom,y=g.classes,b=g.tag,w=g.events.on,x=g.events.off,F=g.events.trigger,E=v.curry,S=v.isDefined,T=v.overload,k="active",L="on",M=t.location,C=M.hash,O={cache:!0},A=new WeakMap,N=E(function(t,e){return e(t)})
...
var D=g.trigger("dom-activate"),P={},j={},q={dialog:function(t){var e,n=t.delegateTarget.getAttribute("data-href")||t.delegateTarget.hash||t.delegateTarget.href,r=n.substring(1),o=P[r]||(P[r]=document.getElementById(r))
...
var i=j[r]||(j[r]=a(e))
F(i,"dom-activate")}}
w(document,"click",g.delegate("a[href]",p)),w(document,"click",g.delegate("a[target]",h)),g.ready(function(){if(g("."+k).forEach(D),C&&/^#\S+$/.test(C))try{g(C).forEach(D)}catch(t){}})}(this),function(t){"use strict"
...
if(r&&(r.pageX!==e.pageX||r.pageY!==e.pageY))return r}function o(t){O(t)&&(e(t)||(L(document,T.move,i,[t]),L(document,T.cancel,u,[t])))}function i(t,e){e.push(t),d(t,e,t,a)}function u(t,e){a()}function a(){M(document,T.move,i),M(document,T.cancel,u)}function c(t){if(!S[t.target.tagName.toLowerCase()]){var e=t.changedTouches[0],n={target:e.target,pageX:e.pageX,pageY:e.pageY,identifier:e.identifier,touchmove:function(){s.apply(this,arguments)},touchend:function(){f.apply(this,arguments)}}
L(document,k.move,n.touchmove,[n]),L(document,k.cancel,n.touchend,[n])}}function s(t,e){var n=r(t,e[0])
n&&d(t,e,n,l)}function f(t,e){var r=n(t.changedTouches,e[0].identifier)
r&&l(e)}function l(t){M(document,k.move,t[0].touchmove),M(document,k.cancel,t[0].touchend)}function d(t,e,n,r){var o=n.pageX-e[0].pageX,i=n.pageY-e[0].pageY
if(!(o*o+i*i<E*E)){var u,a=e[0],c=e[0].target
r(e),C(e[0].target,"dom-touch",{pageX:a.pageX,pageY:a.pageY,detail:function(){return u||(u=b(c,e)),u}})}}function p(t,e){e.touch=t,e.timeStamp=t.timeStamp,e.stream.push(t)}function h(t,e){e.target
m(),e.stream.stop()}function m(){M(document,T.move,p),M(document,T.end,h)}function v(t,e){var n=r(t,e)
...
r&&(y(e),e.stream.stop())}function y(t){M(document,k.move,t.activeTouchmove),M(document,k.end,t.activeTouchend)}function b(t,e){var n=x.from(e).map(function(t){return{x:t.pageX-e[0].pageX,y:t.pageY-e[0].pageY,time:(t.timeStamp-e[0].timeStamp)/1e3}}),r={stream:n,target:t,touch:void 0,identifier:e[0].identifier}
return void 0===r.identifier?(L(t,"click",A),L(document,T.move,p,r),L(document,T.cancel,h,r)):(r.activeTouchmove=function(t,e){v(t,e)},r.activeTouchend=function(t,e){g(t,e)},L(document,k.move,r.activeTouchmove,r),L(document,k.end,r.activeTouchend,r)),n.then(function(){setTimeout(function(){M(t,"click",A)},200)}),n}var w=t.Fn,x=t.Stream,F=t.dom,E=8,S={textarea:!0,input:!0,select:!0,button:!0},T={move:"mousemove",cancel:"mouseup dragstart",end:"mouseup"},k={move:"touchmove",cancel:"touchend",end:"touchend"},L=(w.requestTick,F.events.on),M=F.events.off,C=F.events.trigger,O=F.isPrimaryButton,A=F.preventDefault
L(document,"mousedown",o),L(document,"touchstart",c)}(this),function(t){"use strict"
...
x(),c.trigger("dom-deactivate",u)}var n,r,o=t.timeStamp;(w>o||o>w+g)&&(n=h(c.view,e),r=c.safe.top,w=o+1e3*y,x=d(y,b,"scrollTop",c.view,n[1]-r)),t.default(),u=e}}}function n(t){if(t.default){var e=t.target
...
if(u){if(i===u)return
c.trigger("dom-deactivate",u)}c.trigger("dom-activate",i)}}function i(t){w>=t.timeStamp||(w=t.timeStamp,o())}var u,a=t.Fn,c=t.dom,s=a.by,f=a.noop,l=a.exponentialOut,d=c.animate,p=c.box,h=c.offset,m=c.events.on,v=c.matches(".locateable, [locateable]"),g=90,y=.8,b=l(6),w=0,x=f
...
for(e in o)if("valid"!==e&&o[e])return n=f.validation[F[e]],n&&t.setCustomValidity(n),{type:e,attr:F[e],name:t.name,text:r.validationMessage,node:t}}function i(t){for(var e=t.node,n=e;n.nextElementSibling&&w(n.nextElementSibling);)n=n.nextElementSibling
var r=f.create("label")
f.assign(r,{textContent:t.text,for:e.id,class:"error-label"}),h(n,r)}function u(t){m(t).add(x)}function a(t){for(var e=t;(e=g(e))&&w(e);)y(e)}var c=(Object.assign,t.Fn),s=t.Stream,f=t.dom,l=c.get,d=c.invoke,p=c.nothing,h=(c.once,f.after),m=(f.attribute,f.classes),v=f.matches,g=f.next,y=f.remove,b=v(".validateable, .validateable input, .validateable textarea, .validateable select"),w=v(".error-label"),x="validated",F={patternMismatch:"pattern",rangeOverflow:"max",rangeUnderflow:"min",stepMismatch:"step",tooLong:"maxlength",typeMismatch:"type",valueMissing:"required"}
...
var r,o,i,u,a=[]
for(_.lastIndex=0;_.lastIndex<n.length&&(r=_.exec(n));){if(o=r[1],i=e[o]?e[o].tx:t[o],!i)throw new Error('mount:  transform "'+o+'" not found')
if(r[2]?(u=JSON.parse("["+r[2].replace(/'/g,'"')+"]"),a.push(i.apply(null,u))):a.push(i),"function"!=typeof a[a.length-1])throw new Error('mount:  transform "'+o+'" not resulting in fn')}return A.apply(null,a)}function o(t,e){if(!e)return T
var n,r,o,i,u=[]
for(_.lastIndex=0;_.lastIndex<e.length&&(n=_.exec(e));){if(r=n[1],o=t[r].ix,!o)throw new Error('mount:  transformers "'+r+'" not found')
n[2]?(i=JSON.parse("["+n[2].replace(/'/g,'"')+"]"),u.unshift(o.apply(null,i))):u.unshift(o)}return A.apply(null,u)}function i(t,e,n,r){var o=e.length
...
t.length>u&&c.push(t.slice(u))}function a(t,e,n,r){for(var o;o=t.shift();)c(o,e,n,r)}function c(t,e,n,r){var o=e.getAttribute(n.attributePrefix+t)
return o?e.removeAttribute(n.attributePrefix+t):o=e.getAttribute(H[t]||t),o&&u(o,function(n){e.setAttribute(H[t]||t,n)},n,r)}function s(t,e,n,r){var o=n.rtoken,i=e.getAttribute(n.attributePrefix+t)||e.getAttribute(t)
if(i){o.lastIndex=0
var u=o.exec(i.trim())
...
t.setAttribute("class",c)}}function l(t,e,n){var r=x(e.attributePrefix+"value",t)||x("value",t),o=e.rtoken
o.lastIndex=0
var i=o.exec(r)
if(i)return J(t,e,i,n)}function d(t,e){var n=r(e.transforms,e.transformers,t.pipe),o=F(t.render,n),i=v.throttle(o,requestAnimationFrame,cancelAnimationFrame)
t.update=o,t.push=i}function p(t,e,n){var r
return{shift:C,stop:function(){t.forEach(function(t){t.unbind&&t.unbind(),t.stop&&t.stop()})},push:function(i){if(r!==i){r=i,m&&console.groupCollapsed("update:",n)
var u,a=g(i)
...
var i,c,s
t.listen&&(""===t.path&&console.warn('mount:  Cannot listen to path ""'),i=D(t.path,a),c=o(e.transformers,t.pipe),s=A(function(){return t.read()},c,i),u=t.listen(s),void 0===r&&s())}),m&&console.groupEnd(),i}}}}function h(t,e){e=w({},I,e),m&&console.groupCollapsed("mount: ",t)
var n=[]
return K(t,e,n),m&&(console.table(n,["token","path","pipe"]),console.groupEnd()),p(n,e,t)}var m=t.DEBUG,v=t.Fn,g=t.Observable,y=t.Stream,b=t.dom,w=Object.assign,x=b.attribute,F=v.compose,E=v.curry,S=v.get,T=v.id,k=v.isDefined,L=Number.isNaN,M=v.nothing,C=v.noop,O=v.overload,A=v.pipe,N=v.set,D=v.setPath,P=v.toType,j=/\s+/,q=/\S/,B=/function(?:\s+\w+)?\s*(\([\w,\s]*\))/,I={attributePrefix:"data-",mount:C,transforms:{},transformers:{},rtoken:/(\{\[)\s*(.*?)(?:\s*(\|.*?))?\s*(\]\})/g},_=/\|\s*([\w\-]+)\s*(?::([^|]+))?/g,H={viewbox:"viewBox"},R=E(function(t,e,n){return t.addEventListener(e,n),function(){t.removeEventListener("input",n)}},!0),z=O(P,{boolean:function(t){return t+""},function:function(t){return(t.name||"function")+(B.exec(t.toString())||[])[1]},number:function(t){return Number.isNaN(t)?"":Number.isFinite(t)?t+"":t<0?"-∞":"∞"},string:T,symbol:function(t){return t.toString()},undefined:function(){return""},object:function(t){return t?JSON.stringify(t):""},default:JSON.stringify}),W={1:function(t,e,n){for(var r,o=t.childNodes,i=-1;r=o[++i];)e.mount(r,e,n)||K(r,e,n)
f(t,e,n),a(["id","title","style"],t,e,n),U(t,e,n)},3:function(t,e,n){u(t.nodeValue,N("nodeValue",t),e,n)},8:C,9:function(t,e,n){for(var r,o=t.childNodes,i=-1;r=o[++i];)e.mount(r,e,n)||K(r,e,n)},10:C,11:function(t,e,n){for(var r,o=t.childNodes,i=-1;r=o[++i];)e.mount(r,e,n)||K(r,e,n)}},$={a:function(t,e,n){c("href",t,e,n)},button:function(t,e,n){s("disabled",t,e,n)},input:function(t,e,n){s("disabled",t,e,n),s("required",t,e,n),c("name",t,e,n),V(t,e,n),l(t,e,n)},img:function(t,e,n){c("alt",t,e,n)},label:function(t,e,n){c("for",t,e,n)},option:function(t,e,n){s("disabled",t,e,n),c("value",t,e,n)},select:function(t,e,n){s("disabled",t,e,n),s("required",t,e,n),c("name",t,e,n),l(t,e,n)},textarea:function(t,e,n){s("disabled",t,e,n),s("required",t,e,n),c("name",t,e,n),l(t,e,n)},time:function(t,e,n){a(["datetime"],t,e,n)},svg:function(t,e,n){a(["viewbox"],t,e,n)},g:function(t,e,n){a(["transform"],t,e,n)},path:function(t,e,n){a(["d","transform"],t,e,n)},line:function(t,e,n){a(["x1","x2","y1","y2","transform"],t,e,n)},rect:function(t,e,n){a(["x","y","width","height","rx","ry","transform"],t,e,n)},text:function(t,e,n){a(["x","y","dx","dy","text-anchor"],t,e,n)},use:function(t,e,n){a(["href","transform"],t,e,n)},default:C},X={date:function(t,e,n){a(["min","max","step"],t,e,n)},number:function(t,e,n){a(["min","max","step"],t,e,n)},range:function(t,e,n){a(["min","max","step"],t,e,n)},time:function(t,e,n){a(["min","max","step"],t,e,n)},checkbox:function(){},radio:function(){},default:C},Y={checkbox:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return k(t.getAttribute("value"))?t.checked?t.value:void 0:t.checked},render:function(e){t.checked=k(t.getAttribute("value"))?e===t.value:e===!0},listen:R(t,"change")})},radio:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){if(t.checked)return!k(t.getAttribute("value"))||t.value},render:function(e){t.checked=k(t.getAttribute("value"))?e===t.value:e===!0},listen:R(t,"change")})},number:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return t.value?parseFloat(t.value):void 0},render:function(e){e!==parseFloat(t.value)&&(t.value="number"!=typeof e||L(e)?"":e)},listen:R(t,"input")})},range:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return t.value?parseFloat(t.value):void 0},render:function(e){e!==parseFloat(t.value)&&(t.value="number"!=typeof e||L(e)?"":e)},listen:R(t,"input")})},default:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return t.value},render:function(e){e!==t.value&&(t.value="string"==typeof e?e:"")},listen:R(t,"input")})}},K=O(S("nodeType"),W),U=O(b.tag,$),V=O(S("type"),X),J=O(S("type"),Y)
h.types=W,h.tags=$,h.inputs=X,h.mountAttribute=c,h.mountBoolean=s,h.mountInput=V,h.mountValue=l,h.mountName=function(t,e,n){var r=t.name,o=e.rtoken
o.lastIndex=0
var i=o.exec(r)
if(i)return J(t,e,i,n)},t.mount=h}(this),function(t){t.console&&t.console.log&&console.log("Sparky      - https://github.com/cruncher/sparky")}(this),function(t){"use strict"
function e(t,e){for(var n=[],r=-1;t[++r];)n.push(s(t[r],e))
return{stop:function(){return n.forEach(p("stop",arguments))},push:function(){return n.forEach(p("push",arguments))}}}function n(t){return t.replace(/\//g,"\\/")}function r(t,i,s){function f(){return x=!1,{fn:g}}function l(){b.attributePrefix=r.attributePrefix,b.transforms=r.transforms,b.transformers=r.transformers,!o||s&&s.suppressLogs||console.groupCollapsed("Sparky:",t),S=e(F,b),E.each(S.push),!o||s&&s.suppressLogs||console.groupEnd()}function d(){var t=g.match(y)
if(!t)return F.continue=h,l(),F
var e=r.fn[t[1]]
if(!e)throw new Error('Sparky: fn "'+t[1]+'" not found in Sparky.fn')
var n=t[2]?JSON.parse("["+t[2].replace(/'/g,'"')+"]"):m
return g=g.slice(t[0].length),E=e.call(F,v,E,n)||E,x&&d()}function p(t,e){this.shift=function(){var t
if(void 0!==i)return t=u(i),i=void 0,t},this.push=function(){i=arguments[arguments.length-1],t("push")},this.stop=function(){E.stop&&E.stop!==F.stop&&E.stop(),S.stop&&S.stop(),e(i?1:0)}}if(!r.prototype.isPrototypeOf(this))return new r(t,i,s)
var v=(++w,"string"==typeof t?document.querySelector(n(t)):t),g=s&&s.fn||c.attribute(r.attributePrefix+"fn",v)||"",x=!0,F=this,E=this,S=m
this[0]=v,this.length=1,a.call(this,p),this.interrupt=f,this.continue=d,d()}var o=t.DEBUG,i=t.Fn,u=t.Observable,a=t.Stream,c=t.dom,s=t.mount,f=Object.assign,l=i.deprecate,d=i.getPath,p=i.invoke,h=i.noop,m=i.nothing,v=c.tag,g=c.preventDefault,y=/\s*([-\w]+)(?:\s*:\s*((?:"[^"]*"|'[^']*'|[\w-\[\]]*)(?:\s*,\s*(?:"[^"]*"|'[^']*'|[\w-\[\]]*))*))?/,b={mount:function(t,e,n){var o=c.attribute(r.attributePrefix+"fn",t)
if(o){var i=new r(t,void 0,{fn:o,suppressLogs:!0})
return i.token=o,i.path="",n.push(i),!0}}},w=0
...
function e(t){for(var e="";t--;)e+=" "
return e}function n(t,e,n){for(var r=-1;++r<t.length&&t[r]<n;);if(0===r)return e[0]
if(r>=t.length)return d(e)
if(n===t[r])return e[r]
var o=(n-t[r-1])/(t[r]-t[r-1])
return o*(e[r]-e[r-1])+e[r-1]}var r=t.Fn,o=t.dom,i=t.Sparky,u=t.Time,a=Array.prototype,c=Object.assign,s=r.curry,f=r.get,l=r.isDefined,d=r.last
c(i.transformers={},{add:{tx:r.add,ix:s(function(t,e){return e-t})},decibels:{tx:r.todB,ix:r.toLevel},multiply:{tx:r.multiply,ix:s(function(t,e){return e/t})},degrees:{tx:r.toDeg,ix:r.toRad},radians:{tx:r.toRad,ix:r.toDeg},pow:{tx:r.pow,ix:s(function(t,e){return r.pow(1/t,e)})},exp:{tx:r.exp,ix:r.log},log:{tx:r.log,ix:r.exp},int:{tx:r.toFixed(0),ix:r.toInt},float:{tx:r.toFloat,ix:r.toString},boolean:{tx:Boolean,ix:r.toString},normalise:{tx:r.normalise,ix:r.denormalise},denormalise:{tx:r.denormalise,ix:r.normalise},floatformat:{tx:r.toFixed,ix:s(function(t,e){return parseFloat(e)})},interpolate:{tx:function(t){var e=a.map.call(arguments,f("0")),r=a.map.call(arguments,f("1"))
return function(t){return n(e,r,t)}},ix:function(t){var e=a.map.call(arguments,f("0")),r=a.map.call(arguments,f("1"))
return function(t){return n(r,e,t)}}}}),c(i.transforms,{add:r.add,append:r.append,contains:r.contains,diff:r.diff,equals:r.equals,factorise:r.factorise,gcd:r.gcd,get:r.get,getPath:r.getPath,intersect:r.intersect,invoke:r.invoke,is:r.is,lcm:r.lcm,limit:r.limit,max:r.max,min:r.min,mod:r.mod,not:r.not,percent:r.multiply(100),prepend:r.prepend,rest:r.rest,root:r.nthRoot,slugify:r.slugify,sort:r.sort,take:r.take,toCartesian:r.toCartesian,todB:r.todB,decibels:r.todB,toDeg:r.toDeg,toLevel:r.toLevel,toPolar:r.toPolar,toRad:r.toRad,toStringType:r.toStringType,typeof:r.toType,unique:r.unique,unite:r.unite,escape:o.escape,px:o.toPx,rem:o.toRem,timeformat:function(t,e){return e=e||document.documentElement.lang,function(n){return u(n).render(t,e)}},divide:s(function(t,e){if("number"==typeof e)return e/t}),"find-in":s(function(t,e){if(l(e)){var n=r.getPath(t,i.data)
return n&&n.find(e)}}),first:r.get(0),floatformat:s(function(t,e){return"number"==typeof e?Number.prototype.toFixed.call(e,t):l(e)?i.debug&&console.warn("Sparky: filter floatformat: "+t+" called on non-number "+e):""}),floor:function(t){return Math.floor(t)},"greater-than":s(function(t,e){return e>t}),invert:function(t){return"number"==typeof t?1/t:!t},join:s(function(t,e){return Array.prototype.join.call(e,t)}),json:function(t){return JSON.stringify(t)},last:function(t){return t[t.length-1]},"less-than":s(function(t,e){return e<t}),localise:s(function(t,e){var n=document.documentElement.lang,r={}
return l(t)&&(r.minimumFractionDigits=t,r.maximumFractionDigits=t),e.toLocaleString?e.toLocaleString(n,r):e}),lowercase:function(t){if("string"==typeof t)return String.prototype.toLowerCase.apply(t)},map:s(function(t,e,n){return n&&n.map(i.transforms[t](e))}),pluralise:s(function(t,e,n,r){if("number"==typeof r)return t=t||"",e=e||"s","fr"===n?r<2&&r>=0?t:e:1===r?t:e}),postpad:s(function(t,n){var r=l(n)?n.toString():"",o=r.length,i=parseInt(t,10)
return i===o?n:i>o?r+e(i-o):r.substring(0,i)}),prepad:s(function(t,e,n){var r=l(n)?n.toString():"",o=r.length,i=[]
return t-o<1?n:(i.length=0,i.length=t-o,i.push(r),i.join(e||" "))}),random:function(t){return t[Math.floor(Math.random()*t.length)]},reduce:s(function(t,e,n){return n&&n.reduce(r[t],e||0)}),replace:s(function(t,e,n){if("string"==typeof n)return n.replace(RegExp(t,"g"),e)}),round:s(function(t,e){return Math.round(e/t)*t}),slice:s(function(t,e,n){return"string"==typeof n?n.slice(t,e):Array.prototype.slice.call(n,t,e)}),striptags:function(){var t=/<(?:[^>'"]|"[^"]*"|'[^']*')*>/g
return function(e){return e.replace(t,"")}}(),switch:function(t){if("string"==typeof t&&(t=parseInt(t,10)),"number"==typeof t&&!Number.isNaN(t))return arguments[t+1]},translate:function(){var t={}
return function(e){var n=i.translations
if(!n)return t.missingTranslations||(console.warn("Sparky: Missing lookup object Sparky.translations"),t.missingTranslations=!0),e
var r=n[e]
return r?r:(t[e]||(console.warn('Sparky: Sparky.translations contains no translation for "'+e+'"'),t[e]=!0),e)}}(),truncatechars:s(function(t,e){return e.length>t?e.slice(0,t)+"…":e}),type:function(t){return typeof t},uppercase:function(t){if("string"==typeof t)return String.prototype.toUpperCase.apply(t)},yesno:s(function(t,e,n){return n?t:e})})}(this)
