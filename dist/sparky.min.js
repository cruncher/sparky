...
return e>-1&&n.splice(e,1),t},e).concat(n)}function J(t){return t.unique?t.unique():I(D,[],t)}function K(t,e){return e.sort?e.sort(t):Ft.sort.call(e,t)}function U(t,e){return null===e[t]?void 0:e[t]}function V(t,e,n){return"function"==typeof e.set?e.set(t,n):e[t]=n}function G(t,e,n){for(var r=n.length,o=-1;++o<r;)if(n[o][t]===e)return n[o]}function Q(t,e,n,r){var o=t.exec(e)
if(!o)throw new Error('Fn.getPath(path, object): invalid path "'+e+'"')
var i=o[1],u=o[3]?G(i,o[2]?o[3]:parseFloat(o[3]),n):n[i]
return r(t,e,u)}function Z(t,e,n){return t.lastIndex===e.length?n:n&&"object"==typeof n?Q(t,e,n,Z):void 0}function tt(t,e,n,r){var o=t.exec(e)
if(!o)throw new Error('Fn.getPath(path, object): invalid path "'+e+'"')
var i=o[1]
if(t.lastIndex===e.length){if(o[3])throw new Error('Fn.setPath(path, object): invalid path "'+e+'"')
return n[i]=r}var u=o[3]?G(i,o[2]?o[3]:parseFloat(o[3]),n):n[i]
if(!u||"object"!=typeof u){if(u={},o[3]){if(!n.push)throw new Error("Not supported")
u[i]=o[2]?o[3]:parseFloat(o[3]),n.push(u)}V(i,n,u)}return tt(t,e,u,r)}function et(t,e){return Pt.lastIndex=0,Z(Pt,t,e)}function nt(t,e,n){return Pt.lastIndex=0,tt(Pt,t,e,n)}function rt(t,e){return t+e}function ot(t,e){return e+t}function it(t,e,n){for(var r=-1,o="";o.length<e-n.length;)o+=t[++r%t.length]
...
return[r.left-n.left,r.top-n.top]}function X(t,e){var n=xt({},Ut,e),r=new wt(t,n)
return e&&(delete e.detail,xt(r,e)),r}function J(t){t.preventDefault()}function K(t){return 1===t.which&&!t.ctrlKey&&!t.altKey&&!t.shiftKey}function U(t){return Gt[t.keyCode]}function V(t,n,r,o){n=n.split(_t)
for(var i,u,a=t[Vt]||(t[Vt]={}),c=e(r,o),s=-1;s++<n.length;)u=n[s],i=a[u]||(a[u]=[]),i.push([r,c]),t.addEventListener(u,c)
return t}function G(t,e,n){e=e.split(_t)
var r,o,i,u=t[Vt]
if(!u)return t
for(var a=-1;a++<e.length;)if(r=e[a],o=u[r])for(i=o.length;i--;)o[i][0]===n&&(t.removeEventListener(r,o[i][1]),o.splice(i,1))
return t}function Q(t,e,n){var r=X(e,n)
t.dispatchEvent(r)}function Z(t,e){G(t.currentTarget,Ht.transitionend,Z),e(t.timeStamp)}function tt(t,e,n){if("transitionend"===t){if(!Ht.transition)return void e(performance.now())
t=Ht.transitionend}V(n,t,Z,e)}function et(t,e){return function(n){var r=k(t,n.target,n.currentTarget)
...
e&&e.focus()}function n(n){t.contains(n.target)||(e(),n.preventDefault(),n.stopPropagation())}Qt()
var r=document.activeElement||document.body
return document.addEventListener("focus",n,!0),Pt(e),Qt=function(){Qt=Lt,document.removeEventListener("focus",n,!0),Pt(function(){r.focus()})}}function ot(t){if(t.domFragmentFromChildren)return t.domFragmentFromChildren
var e=a("fragment")
...
return function(t){return r[t]||(r[t]=e(t))}}(["Khtml","O","Moz","Webkit","ms"]),Ut={bubbles:!0},Vt=Symbol("events"),Gt={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",27:"escape",32:"space",33:"pageup",34:"pagedown",35:"pageright",36:"pageleft",37:"left",38:"up",39:"right",40:"down",46:"delete",48:"0",49:"1",50:"2",51:"3",52:"4",53:"5",54:"6",55:"7",56:"8",57:"9",65:"a",66:"b",67:"c",68:"d",69:"e",70:"f",71:"g",72:"h",73:"i",74:"j",75:"k",76:"l",77:"m",78:"n",79:"o",80:"p",81:"q",82:"r",83:"s",84:"t",85:"u",86:"v",87:"w",88:"x",89:"y",90:"z",91:"cmd",93:"cmd",186:";",187:"=",188:",",189:"-",190:".",191:"/",219:"[",220:"\\",221:"]",222:"'",224:"cmd"},Qt=Lt,Zt={xml:"application/xml",html:"text/html",svg:"image/svg+xml"},te=function(){var t=document.createElement("pre"),e=document.createTextNode("")
...
if(r[2]?(u=JSON.parse("["+r[2].replace(/'/g,'"')+"]"),a.push(i.apply(null,u))):a.push(i),"function"!=typeof a[a.length-1])throw new Error('Sparky: transform "'+o+'" not resulting in fn')}return C.apply(null,a)}function o(t,e){if(!e)return T
var n,r,o,i,u=[]
...
o.lastIndex=0
var i=o.exec(r)
if(i)return U(t,e,i,n)}function d(t,e){var n=r(e.transforms,e.transformers,t.pipe),o=x(t.render,n),i=v.throttle(o,requestAnimationFrame,cancelAnimationFrame)
t.update=o,t.push=i}function p(t,e,n){var r
return{shift:L,stop:function(){t.forEach(function(t){t.unbind&&t.unbind(),t.stop&&t.stop()})},push:function(i){if(r!==i){r=i,m&&console.groupCollapsed("Sparky: update",n)
var u,a=g(i)
...
var i,c,s
t.listen&&(i=N(t.path,a),c=o(e.transformers,t.pipe),s=C(function(){return t.read()},c,i),u=t.listen(s),void 0===r&&s())}),m&&console.groupEnd(),i}}}}function h(t,e){e=w({},_,e),m&&console.groupCollapsed("Sparky: mount ",t)
var n=[]
...
if(/#/.test(f)?(u=f.split("#"),a=u[0]||"",c=u[1]||""):(console.warn('Deprecated: Sparky template:url url should be a url or hash ref, actually an id: "'+f+'"'),a="",c=f),o&&!a)throw new Error("Sparky: "+s.attributePrefix+'fn="import:url" requires a url.')
var l=this
...
w&&d(w,"",c),e.each(function(t){b(),b=d(t,"",y)}),this.on("then",function(){y.cancel(),b()})}}(this),function(t){"use strict"
