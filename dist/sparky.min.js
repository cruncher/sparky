...
return function(e){return 1===arguments.length?r(e):arguments.length===n?t.apply(null,arguments):arguments.length>n?d(t.apply(null,wt.splice.call(arguments,0,n)),arguments):d(r(e),wt.slice.call(arguments,1))}}function h(t){return function(){var e=t.apply(this,arguments)
...
return!0}function b(t){return!!t||void 0!==t&&null!==t&&!Number.isNaN(t)}function F(t,e){return t!==e}function w(t){return typeof t}function x(t){return Et.toString.apply(t).slice(8,-1)}function E(t){if(t.toArray)return t.toArray()
var e,n=[],r=t.length
...
return o}function D(t,e){return t.indexOf(e)===-1&&t.push(e),t}function L(t,e){return t.push(e),t}function O(t,e){return t===e?0:t>e?1:-1}function A(t,e){return Array.isArray(e)?e.concat(Array.isArray(t)?t:E(t)):e.concat?e.concat(t):E(e).concat(Array.isArray(t)?t:E(t))}function C(t,e){return e.includes?e.includes(t):e.contains?e.contains(t):wt.includes?wt.includes.call(e,t):wt.indexOf.call(e,t)!==-1}function N(t,e){return e.map?e.map(t):wt.map.call(e,t)}function j(t,e){var n,r
if("function"==typeof e.each)e.each(t)
else for(n=e.length,r=-1;++r<n;)t(e[r])
return e}function q(t,e){return e.filter?e.filter(t):wt.filter.call(e,t)}function P(t){if("number"==typeof t.length)return t[t.length-1]}function _(t,e,n){return n.reduce?n.reduce(t,e):wt.reduce.call(n,t,e)}function I(t,e){if(e.slice)return e.slice(t)
...
return n}function H(t,e){return wt.find.call(e,t)}function z(t,e,n){for(var r=-1,o=e.length,i=t(n);++r<o&&t(e[r])<=i;);e.splice(r,0,n)}function R(t,e){t.remove&&t.remove(e)
var n=t.indexOf(e)
...
return e>-1&&n.splice(e,1),t},e).concat(n)}function J(t){return t.unique?t.unique():_(D,[],t)}function K(t,e){return e.sort?e.sort(t):wt.sort.call(e,t)}function U(t,e){return null===e[t]?void 0:e[t]}function G(t,e,n){return"function"==typeof e.set?e.set(t,n):e[t]=n}function Q(t,e,n){for(var r=n.length,o=-1;++o<r;)if(n[o][t]===e)return n[o]}function V(t,e,n,r){var o=t.exec(e)
...
u[i]=o[2]?o[3]:parseFloat(o[3]),n.push(u)}G(i,n,u)}return tt(t,e,u,r)}function et(t,e){return Nt.lastIndex=0,Z(Nt,t,e)}function nt(t,e,n){return Nt.lastIndex=0,tt(Nt,t,e,n)}function rt(t,e){return t+e}function ot(t,e){return e+t}function it(t,e,n){for(var r=-1,o="";o.length<e-n.length;)o+=t[++r%t.length]
...
r>i?s=c:f=c,c=.5*(f-s)+s}return c}function dt(t){return Pt.then(t),!0}function pt(t,e){function n(){var t=o.length
...
return yt(this,function(){return gt(t)})},".last() is now .latest()")}),bt.prototype.toArray=bt.prototype.toJSON,t.Symbol&&(bt.prototype[Symbol.iterator]=function(){return this}),t.Fn=Tt(bt,{of:function(){return bt.from(arguments)},from:function(t){if("function"==typeof t.shift&&void 0===t.length)return new bt(function(){return t.shift()})
if("function"==typeof t.next)return new bt(function e(){var n=t.next()
return n.done?n.value:void 0===n.value?e():n.value})
var e=-1
return new bt(function n(){return++e>=t.length?void 0:void 0===t[e]?n():t[e]})},Timer:pt,nothing:kt,id:i,noop:o,self:u,cache:l,compose:s,curry:p,choose:g,flip:m,once:h,overload:p(v),pipe:f,throttle:ht,wait:mt,equals:p(y),is:p(At),isDefined:b,isIn:p(Ct,!0),isNot:p(F),and:p(function(t,e){return!(!t||!e)}),not:function(t){return!t},or:p(function(t,e){return t||e}),xor:p(function(t,e){return(t||e)&&!!t!=!!e}),isGreater:p(function(t,e){return e>t}),by:p(function(t,e,n){return O(e[t],n[t])},!0),byGreater:p(O),byAlphabet:p(function(t,e){return St.localeCompare.call(t,e)}),toType:w,toClass:x,toArray:E,toString:T,toInt:S,toFloat:parseFloat,toPlainText:function(t){return t.normalize("NFD").replace(/[\u0300-\u036f]/g,"")},toStringType:function(t,e){return function(n){for(var r=e.length;r--;)if(t[e[r]].test(n))return e[r]
try{return JSON.parse(n),"json"}catch(t){}return"string"}}(Ot,["url","date","email","float","int"]),concat:p(A,!0),contains:p(C,!0),diff:p($,!0),each:p(j,!0),filter:p(q,!0),find:p(H,!0),insert:p(z,!0),intersect:p(W,!0),last:P,latest:gt,map:p(N,!0),reduce:p(_,!0),remove:p(R,!0),rest:p(I,!0),sort:p(K,!0),split:p(Y,!0),take:p(B,!0),unite:p(X,!0),unique:J,assign:p(Tt,!0,2),get:p(U,!0),set:p(G,!0),getPath:p(et,!0),setPath:p(nt,!0),invoke:p(function(t,e,n){return n[t].apply(n,e)},!0),add:p(function(t,e){return e+t}),multiply:p(function(t,e){return e*t}),mod:p(function(t,e){return e%t}),min:p(function(t,e){return t>e?e:t}),max:p(function(t,e){return t<e?e:t}),pow:p(function(t,e){return Math.pow(e,t)}),exp:p(function(t,e){return Math.pow(t,e)}),log:p(function(t,e){return Math.log(e)/Math.log(t)}),root:p(function(t,e){return Math.pow(e,1/t)}),gcd:p(at),lcm:p(ct),todB:function(t){return 20*Math.log10(t)},toLevel:function(t){return Math.pow(2,t/6)},toRad:function(t){return t/Mt},toDeg:function(t){return t*Mt},factorise:function(t,e){var n=at(t,e)
...
this._notify=t,this._stop=e,this._sources=n,this._values=o,this._buffer=i,this._i=0,this._update=r,w(function(e){o.push.apply(o,k(e)),e.on("push",r),e.on("push",t)},n)}function p(t){var n=this,r=[],o=[]
...
this.cancel=n.cancel||E,this.end=e,this.id=i(r)}var g=!1,y=t.Fn,b=Array.prototype,F=Object.assign,w=(y.curry,y.each),x=y.latest,E=y.noop,S=y.now,T=(y.nothing,y.rest,y.throttle,y.Timer),k=y.toArray,M=Symbol("events"),D={shift:E,push:E,start:E,stop:E}
F(a.prototype,D,{shift:function(){return--this.n<1&&this.done(),this.source.shift()}}),F(s.prototype,{shift:function(){var t=this._buffer,e=this._notify
...
return new s(e,r,o)})},c.of=function(){return c.from(arguments)},F(l.prototype,{shift:function(){if(this._hot){this._hot=!1
...
F(p.prototype,{request:function(t){return this.fns.push(t),t},cancel:function(t){remove(this.fns,t)}}),F(m.prototype,{shift:function(){var t=this.value
...
return t="number"==typeof t?new T(t):t instanceof c?new p(t):t?t:L,new c(function(e,n){return new m(e,n,t)})},F(v.prototype,{shift:function(){var t=this.value
...
return new c(v,e)},c.prototype=F(Object.create(y.prototype),{clone:function(){var t=this,e=this.shift,n=[],r=[],o=new c(function(o,i){var u=r
...
t.splice(n,1)}function s(t,n){return t!==n.value&&(n.value=t,n(t)),e}function f(t,e){var n=a(t,F),r=e.value
return n.push(e),t!==e.value&&(e.value=t,e(t,{index:0,removed:r?r:w,added:t})),function(){c(n,e)}}function l(t,n,r,o,i){function u(t){return t[n]===r}function a(t){var e=t&&m.find.call(t,u)
...
o(n[e],t[y]),o(n[F],t)}if(!t.Proxy)return void console.warn("Proxy constructor not found. This version of Observable cannot be used.")
var m=Array.prototype,v=Object.assign,g=Object.isExtensible,y=Symbol("observable"),b=Symbol("observers"),F=Symbol("update"),w=Object.freeze([]),x=/\[?([-\w]+)(?:=(['"])?([-\w]+)\2)?\]?\.?/g,E={get:r,set:function(t,e,n,r){if("symbol"==typeof e)return t[e]=n,!0
var i=t[e]
if(i===n)return!0
var a,c=t[b]
if("length"===e){if(n>=t.length)return!0
for(a={index:n,removed:m.splice.call(t,n),added:w};--i>=n;)o(c[i],void 0)}else if(+e%1===0)if(e=+e,void 0===n){if(!(e<t.length))return!0
a={index:e,removed:m.splice.call(t,e,1),added:w},n=t[e]}else a={index:e,removed:m.splice.call(t,e,1,n),added:[n]}
else t[e]=n
return o(c[e],u(n)||n),o(c[F],r,a),!0}},S={get:r,set:function(t,e,n,r){var i=t[e]
if(i===n)return!0
t[e]=n
var a=t[b]
return o(a[e],u(n)||n),o(a[F],r),!0}}
...
return n}function o(t,e,n){this.node=t,this.get=e,this.set=n}function i(t,e){for(var n=Object.keys(e),r=n.length;r--;)t.setAttribute(n[r],e[n[r]])}function u(t,e){for(var n=Object.keys(e),r=n.length;r--;)t.setAttributeNS(null,n[r],e[n[r]])}function a(t){if($t[t])return $t[t](arguments[1])
...
if(e.length){var n=e.reduce?e:Pt.slice.call(e)
return n.reduce(L,t),e}}function A(t){for(;t.lastChild;)t.removeChild(t.lastChild)}function C(t){t.parentNode&&t.parentNode.removeChild(t)}function N(t){t instanceof yt||t instanceof bt?C(t):Pt.forEach.call(t,C)}function j(t,e){t.parentNode&&t.parentNode.insertBefore(e,t)}function q(t,e){t.parentNode&&t.parentNode.insertBefore(e,t.nextSibling)}function P(t,e){return j(t,e),N(t),t}function _(t){return t.split("(")[1].split(")")[0].split(/\s*,\s*/)}function I(e,n){return t.getComputedStyle?t.getComputedStyle(n,null).getPropertyValue(e):0}function B(e){var n=document.body,r=document.documentElement,o=e.getBoundingClientRect(),i=t.pageXOffset||r.scrollLeft||n.scrollLeft,u=r.clientLeft||n.clientLeft||0
...
return[r.left-n.left,r.top-n.top]}function X(t,e){var n=xt({},Ut,e),r=new Ft(t,n)
return e&&(delete e.detail,xt(r,e)),r}function J(t){t.preventDefault()}function K(t){return 1===t.which&&!t.ctrlKey&&!t.altKey&&!t.shiftKey}function U(t){return Qt[t.keyCode]}function G(t,n,r,o){n=n.split(It)
...
r&&(n.delegateTarget=r,e(n,r),n.delegateTarget=void 0)}}function nt(t,e){return t=t.split(It),new wt(function(n,r){function o(t){i.push(t),n("push")}var i=[]
...
return document.addEventListener("focus",n,!0),jt(e),Vt=function(){Vt=Lt,document.removeEventListener("focus",n,!0),jt(function(){r.focus()})}}function ot(t){if(t.domFragmentFromChildren)return t.domFragmentFromChildren
var e=a("fragment")
...
return r}function st(){return Wt||(Wt=parseFloat(I("font-size",document.documentElement),10))}function ft(t,e){function n(i){var u=(i-r)/(1e3*t)
u<1?(u>0&&e(u),o=requestAnimationFrame(n)):e(1)}var r=performance.now(),o=requestAnimationFrame(n)
return function(){cancelAnimationFrame(o)}}function lt(t,e,n,r,o){return ft(t,At(e,kt(r[n],o),Nt(n,r)))}function dt(t){return lt(.6,Ct(2),"scrollTop",vt.viewport,ne(t))}function pt(t){return t.scrollTop/(t.scrollHeight-t.clientHeight)}function ht(t){t=t||document.documentElement
...
var e=t.scrollLeft,n=t.scrollTop
t.style.overflow="",n&&(t.scrollTop=n),e&&(t.scrollLeft=e)}function vt(t){return E(t,document)}var gt=t.Fn,yt=t.Node,bt=t.SVGElement,Ft=t.CustomEvent,wt=t.Stream,xt=Object.assign,Et=Object.defineProperties,St=gt.cache,Tt=(gt.compose,gt.curry),kt=gt.denormalise,Mt=gt.deprecate,Dt=gt.id,Lt=gt.noop,Ot=gt.overload,At=gt.pipe,Ct=gt.pow,Nt=gt.set,jt=gt.requestTick,qt=gt.toType,Pt=Array.prototype,_t="http://www.w3.org/2000/svg",It=/\s+/,Bt=/px$/,Ht=Et({},{inputEventsWhileDisabled:{get:St(function(){var t=document.createElement("input"),e=X("featuretest"),n=!1
return L(document.body,t),t.disabled=!0,t.addEventListener("featuretest",function(t){n=!0}),t.dispatchEvent(e),C(t),n}),enumerable:!0},template:{get:St(function(){return"content"in document.createElement("template")}),enumerable:!0},textareaPlaceholderSet:{get:St(function(){var t=document.createElement("textarea")
return t.setAttribute("placeholder","---"),""===t.innerHTML}),enumerable:!0},transition:{get:St(function(){var t=Kt("transition")
return t||!1}),enumerable:!0},transitionend:{get:St(function(){var t={KhtmlTransition:!1,OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd",msTransition:"MSTransitionEnd",transition:"transitionend"},e=Kt("transition")
...
Yt.forEach(function(t){$t[t]=function(e){var n=document.createElementNS(_t,t)
return e&&u(n,e),n}})
...
return n},Jt={"transform:translateX":function(t){var e=I("transform",t)
...
if(!e||"none"===e)return 0
var n=_(e),r=parseFloat(n[0]),o=parseFloat(n[1])
...
xt(vt,{ready:oe.then.bind(oe),get:function(t){return document.getElementById(t)||void 0},find:gt.deprecate(function(t){return document.getElementById(t)||void 0},"dom.find(id) is now dom.get(id)"),query:Tt(E,!0),closest:Tt(k,!0),contains:Tt(S,!0),matches:Tt(T,!0),children:x,next:M,previous:D,assign:Tt(i,!0),create:a,clone:Xt,identify:h,append:Tt(O,!0),before:Tt(j,!0),after:Tt(q,!0),replace:Tt(P,!0),empty:A,remove:N,isElementNode:s,isTextNode:f,isCommentNode:l,isFragmentNode:d,isInternalLink:p,type:c,tag:m,attribute:Tt(v,!0),classes:y,addClass:Tt(b,!0),removeClass:Tt(F,!0),flashClass:Tt(w,!0),box:R,bounds:Y,rectangle:Mt(R,"dom.rectangle(node) now dom.box(node)"),offset:Tt(W,!0),position:$,prefix:Kt,style:Tt(function(t,e){if(Jt[t])return Jt[t](e)
var n=I(t,e)
return"string"==typeof n&&Bt.test(n)?parseFloat(n):n},!0),toPx:ne,toRem:re,viewportLeft:B,viewportTop:H,fragmentFromTemplate:ut,fragmentFromChildren:ot,fragmentFromHTML:it,fragmentFromId:at,escape:te,parse:Tt(ct),Event:X,delegate:et,isPrimaryButton:K,preventDefault:J,toKey:U,trapFocus:rt,trap:gt.deprecate(rt,"dom.trap() is now dom.trapFocus()"),events:{on:G,off:Q,trigger:V},on:gt.deprecate(Tt(nt,!0),"dom.on() is now dom.event()"),trigger:Tt(function(t,e){return V(e,t),e},!0),event:Tt(nt,!0),transition:Tt(ft,!0),schedule:Mt(ft,"dom: .schedule() is now .transition()"),animate:Tt(lt,!0),animateScroll:dt,scrollTo:Mt(dt,"scrollTo(px, node) renamed to animateScroll(px)"),scrollRatio:pt,disableScroll:ht,enableScroll:mt,requestEvent:tt,requestFrame:requestAnimationFrame.bind(null),requestFrameN:Tt(Mt(function(t,e){!function n(){return requestAnimationFrame(--t?n:e)}()},"requestFrameN() will be removed soon"),!0),features:Ht,safe:Et({left:0},{right:{get:function(){return t.innerWidth},enumerable:!0,configurable:!0},top:{get:function(){return I("padding-top",document.body)},enumerable:!0,configurable:!0},bottom:{get:function(){return t.innerHeight},enumerable:!0,configurable:!0}})}),Et(vt,{root:{value:document.documentElement,enumerable:!0},head:{value:document.head,enumerable:!0},body:{get:function(){return document.body},enumerable:!0},viewport:{get:function(){return document.scrollingElement},enumerable:!0}}),t.dom=vt}(this),function(t){"use strict"
function e(t){return g.query('[href$="#'+t+'"]',g.body).filter(S(b,{a:g.isInternalLink,default:function(){return!0}})).concat(g.query('[data-href="#'+t+'"]',document))}function n(t){var e=O.get(t)
return e||(e={},O.set(t,e)),e}function r(t){var r=n(t),o=t.id
...
e.active||(e.active=!0,this.preventDefault(),m&&console.log("[activate] default | target:",this.target.id,"data:",e),y(e.node).add(T),t=o(e),t&&t.forEach(function(t){g.classes(t).add(k)}))}function u(){var t,e=this.data||r(this.target)
e.active&&(e.active=!1,this.preventDefault(),m&&console.log("[deactivate] default | target:",this.target.id,"data:",e),y(e.node).remove(T),t=o(e),t&&t.forEach(function(t){g.classes(t).remove(k)}))}function a(t){var e=g.create("div",{class:"dialog-layer layer"}),n=g.create("div",{class:"dialog popable"}),r=g.create("button",{class:"close-thumb thumb"})
return g.append(n,t),g.append(e,n),g.append(e,r),g.append(document.body,e),n}function c(t){"mousedown"===t.type&&F(t.currentTarget,"click",function t(e){w(e.currentTarget,"click",t),e.preventDefault()})}function s(t){return!!t.defaultPrevented||(!g.isPrimaryButton(t)||(("keydown"===t.type||"keyup"===t.type)&&13!==t.keyCode||void 0))}function f(t,e){t.preventDefault(),"mousedown"===t.type&&c(t),x(e,"dom-activate",{relatedTarget:t.currentTarget})}function l(t){return(E(t.hash)?t.hash:t.getAttribute("href")).substring(1)}function d(t,e){var n=document.getElementById(e)
if(n){var r=g.classes(n)
r.contains("popable")||r.contains("switchable")||r.contains("toggleable")||r.contains("focusable")||r.contains("removeable")||r.contains("locateable")?f(t,n):g.activateOther&&g.activateOther(n)}}function p(t){if(!s(t)&&(!t.delegateTarget.hostname||g.isInternalLink(t.delegateTarget))){var e=l(t.delegateTarget)
e&&d(t,e)}}function h(t){var e=t.delegateTarget.target
if(!s(t)&&j[e])return j[e](t)}var m=!1,v=t.Fn,g=t.dom,y=g.classes,b=g.tag,F=g.events.on,w=g.events.off,x=g.events.trigger,E=v.isDefined,S=v.overload,T="active",k="on",M=t.location,D=M.hash,L={cache:!0},O=new WeakMap
...
var A=g.trigger("dom-activate"),C={},N={},j={dialog:function(t){var e,n=t.delegateTarget.getAttribute("data-href")||t.delegateTarget.hash||t.delegateTarget.href,r=n.substring(1),o=C[r]||(C[r]=document.getElementById(r))
...
var i=N[r]||(N[r]=a(e))
x(i,"dom-activate")}}
F(document,"click",g.delegate("[href]",p)),F(document,"click",g.delegate("a[target]",h)),g.ready(function(){if(g("."+T).forEach(A),D&&/^#\S+$/.test(D))try{g(D).forEach(A)}catch(t){}})}(this),function(t){"use strict"
...
r&&(y(e),e.stream.stop())}function y(t){D(document,k.move,t.activeTouchmove),D(document,k.end,t.activeTouchend)}function b(t,e){var n=w.from(e).map(function(t){return{x:t.pageX-e[0].pageX,y:t.pageY-e[0].pageY,time:(t.timeStamp-e[0].timeStamp)/1e3}}),r={stream:n,target:t,touch:void 0,identifier:e[0].identifier}
return void 0===r.identifier?(M(t,"click",A),M(document,T.move,p,r),M(document,T.cancel,h,r)):(r.activeTouchmove=function(t,e){v(t,e)},r.activeTouchend=function(t,e){g(t,e)},M(document,k.move,r.activeTouchmove,r),M(document,k.end,r.activeTouchend,r)),n.then(function(){setTimeout(function(){D(t,"click",A)},200)}),n}var F=t.Fn,w=t.Stream,x=t.dom,E=8,S={textarea:!0,input:!0,select:!0,button:!0},T={move:"mousemove",cancel:"mouseup dragstart",end:"mouseup"},k={move:"touchmove",cancel:"touchend",end:"touchend"},M=(F.requestTick,x.events.on),D=x.events.off,L=x.events.trigger,O=x.isPrimaryButton,A=x.preventDefault
...
return r-n}function r(t,e){var n=u.viewportLeft(t),r=u.viewportLeft(e),o=Math.round(n-r-u.style("margin-left",e))
...
var o=u.viewportLeft(e),i=u.viewportLeft(n),a=o-i-u.style("margin-left",e)
n.style.transform="translate("+-a+"px, 0px)",t.preventDefault()}}})}(this),function(t){"use strict"
var e=t.Fn,n=t.dom,r=e.noop,o=(e.requestTick,n.events.on),i=n.events.off,u=n.events.trigger,a=n.disableScroll,c=n.enableScroll,s=n.trapFocus,f=r,l=n.matches(".focusable"),d=600
...
if(p(e).contains(g)&&e!==u){if(u){if(e===u)return
x(),c.trigger("dom-deactivate",u)}var n,r,o=t.timeStamp;(w>o||o>w+y)&&(n=m(c.viewport,e),r=c.safe.top,w=o+1e3*b,x=d(b,F,"scrollTop",c.viewport,n[1]-r)),t.default(),u=e}}}function n(t){if(t.default){var e=t.target
p(e).contains(g)&&(t.default(),e===u&&(u=void 0))}}function r(){return{left:0,top:0,right:t.innerWidth,bottom:t.innerHeight,width:t.innerWidth,height:t.innerHeight}}function o(){for(var t=c(".locateable"),e=t.map(h).sort(s("top")),n=r(),o=-1;e[++o]&&!(e[o].top>n.height/2););if(--o,!(o<0||o>=e.length)){var i=t[o]
if(u){if(i===u)return
c.trigger("dom-deactivate",u)}c.trigger("dom-activate",i)}}function i(t){w>=t.timeStamp||(w=t.timeStamp,o())}var u,a=t.Fn,c=t.dom,s=a.by,f=a.noop,l=a.exponentialOut,d=c.animate,p=c.classes,h=c.box,m=c.offset,v=c.events.on,g="locateable",y=90,b=.8,F=l(6),w=0,x=f
v(document,"dom-activate",e),v(document,"dom-deactivate",n),v(t,"scroll",i),o()}(this),function(t){"use strict"
function e(t,e){var n=I(e).trim().split(j)
t.add.apply(t,n)}function n(t,e){var n=I(e).trim().split(j)
t.remove.apply(t,n)}function r(t,e,n){if(!n)return S
var r,o,i,u,a=[]
for(B.lastIndex=0;B.lastIndex<n.length&&(r=B.exec(n));){if(o=r[1],i=e[o]?e[o].transform:t[o],!i)throw new Error('Sparky: transform "'+o+'" not found')
if(r[2]?(u=JSON.parse("["+r[2].replace(/'/g,'"')+"]"),a.push(i.apply(null,u))):a.push(i),"function"!=typeof a[a.length-1])throw new Error('Sparky: transform "'+o+'" not resulting in fn')}return O.apply(null,a)}function o(t,e){if(!e)return S
var n,r,o,i,u=[]
for(B.lastIndex=0;B.lastIndex<e.length&&(n=B.exec(e));){if(r=n[1],o=t[r].invert,!o)throw new Error('Sparky: transformers "'+r+'" not found')
n[2]?(i=JSON.parse("["+n[2].replace(/'/g,'"')+"]"),u.unshift(o.apply(null,i))):u.unshift(o)}return O.apply(null,u)}function i(t,e,n,r,o){var i=n.length
n.push(""),r.push({token:o[0],path:o[2],pipe:o[3],render:function(t){n[i]=I(t),e(n)}})}function u(t,e,n,r){var o=n.rtoken,u=o.lastIndex=0,a=o.exec(t)
if(!a)return M
for(var c=[],s=function(t){e(t.join(""))};a;)a.index>u&&c.push(t.slice(u,a.index)),i(t,s,c,r,a),u=o.lastIndex,a=o.exec(t)
t.length>u+1&&c.push(t.slice(u))}function a(t,e,n,r){for(var o;o=t.shift();)c(o,e,n,r)}function c(t,e,n,r){var o=b.attribute(t,e)
return o?u(o,function(n){e.setAttribute(t,n)},n,r):M}function s(t,e,n,r){var o=n.rtoken,i=e.getAttribute(n.prefix+t)||e.getAttribute(t)
if(i){o.lastIndex=0
var u=o.exec(i.trim())
...
t.setAttribute("class",c)}}function l(t,e,n){var r=t.name,o=e.rtoken
o.lastIndex=0
var i=o.exec(r)
if(i)return K(t,e,i,n)}function d(t,e){var n=r(e.transforms,e.transformers,t.pipe)
t.push=w(t.render,n),t.throttle=v.throttle(t.push,requestAnimationFrame,cancelAnimationFrame)}function p(t,e,n){var r
return{shift:D,stop:function(){t.forEach(function(t){t.unbind&&t.unbind(),t.stop&&t.stop()})},push:function(i){if(r!==i){r=i,m&&console.groupCollapsed("Sparky: update",n)
var u,a=g(i)
return t.forEach(function(t){t.unbind&&t.unbind(),t.push||d(t,e),t.unbind=t.unbind||function(e){t.throttle&&t.throttle.cancel(),t.input.stop(),t.listen&&u()}
var n=t.input=y.observe(t.path,a),r=n.latest().shift()
void 0!==r&&t.push(r),n.each(t.throttle||t.push)
var i,c,s
t.listen&&(i=C(t.path,a),c=o(e.transformers,t.pipe),s=O(function(){return t.read()},c,i),u=t.listen(s),void 0===r&&s())}),m&&console.groupEnd(),i}}}}function h(t,e){e=F({},_,e),m&&console.groupCollapsed("Sparky: mount ",t)
var n=[]
return W(t,e,n),m&&(console.table(n,["token","path","pipe"]),console.groupEnd()),p(n,e,t)}var m=t.DEBUG,v=t.Fn,g=t.Observable,y=t.Stream,b=t.dom,F=Object.assign,w=v.compose,x=v.curry,E=v.get,S=v.id,T=v.isDefined,k=Number.isNaN,M=v.nothing,D=v.noop,L=v.overload,O=v.pipe,A=v.set,C=v.setPath,N=v.toType,j=/\s+/,q=/\S/,P=/function(?:\s+\w+)?\s*(\([\w,\s]*\))/,_={prefix:"data-",mount:D,transforms:{},transformers:{},rtoken:/(\{\[)\s*(.*?)(?:\s*(\|.*?))?\s*(\]\})/g},I=L(N,{boolean:function(t){return t+""},function:function(t){return(t.name||"function")+(P.exec(t.toString())||[])[1]},number:function(t){return Number.isNaN(t)?"":t+""},string:S,symbol:function(t){return t.toString()},undefined:function(){return""},object:function(t){return null===t?"":JSON.stringify(t)},default:JSON.stringify}),B=/\|\s*([\w\-]+)\s*(?::([^|]+))?/g,H=x(function(t,e,n){return t.addEventListener(e,n),function(){t.removeEventListener("input",n)}},!0),z={1:function(t,e,n){for(var r,o,i=t.childNodes,u=-1;r=i[++u];)o=e.mount(r),o?n.push(o):W(r,e,n)
f(t,e,n),a(["id","title","style"],t,e,n),X(t,e,n),m&&console.log("mounted:",t,n.length)},3:function(t,e,n){u(t.nodeValue,A("nodeValue",t),e,n)},8:D,11:function(t,e,n){for(var r,o,i=t.childNodes,u=-1;r=i[++u];)o=e.mount(r),o?n.push(o):W(r,e,n)}},R={a:function(t,e,n){c("href",t,e,n)},button:function(t,e,n){s("disabled",t,e,n)},input:function(t,e,n){s("disabled",t,e,n),s("required",t,e,n),a(["value"],t,e,n),J(t,e,n),l(t,e,n)},img:function(t,e,n){c("alt",t,e,n)},label:function(t,e,n){c("for",t,e,n)},option:function(t,e,n){s("disabled",t,e,n),c("value",t,e,n)},select:function(t,e,n){s("disabled",t,e,n),s("required",t,e,n),c("value",t,e,n),l(t,e,n)},textarea:function(t,e,n){s("disabled",t,e,n),s("required",t,e,n),l(t,e,n)},time:function(t,e,n){a(["datetime"],t,e,n)},svg:function(t,e,n){a(["viewbox"],t,e,n)},g:function(t,e,n){a(["transform"],t,e,n)},path:function(t,e,n){a(["d","transform"],t,e,n)},line:function(t,e,n){a(["x1","x2","y1","y2","transform"],t,e,n)},rect:function(t,e,n){a(["x","y","width","height","rx","ry","transform"],t,e,n)},text:function(t,e,n){a(["x","y","dx","dy","text-anchor"],t,e,n)},use:function(t,e,n){a(["href","transform"],t,e,n)},default:D},Y={date:function(t,e,n){a(["min","max","step"],t,e,n)},number:function(t,e,n){a(["min","max","step"],t,e,n)},range:function(t,e,n){a(["min","max","step"],t,e,n)},time:function(t,e,n){a(["min","max","step"],t,e,n)},checkbox:function(){},radio:function(){},default:D},$={checkbox:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return T(t.getAttribute("value"))?t.checked?t.value:void 0:t.checked},render:function(e){t.checked=T(t.getAttribute("value"))?e===t.value:e===!0},listen:H(t,"change")})},radio:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){if(t.checked)return!T(t.getAttribute("value"))||t.value},render:function(e){t.checked=T(t.getAttribute("value"))?e===t.value:e===!0},listen:H(t,"change")})},number:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return t.value?parseFloat(t.value):void 0},render:function(e){e!==parseFloat(t.value)&&(t.value="number"!=typeof e||k(e)?"":e)},listen:H(t,"input")})},range:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return t.value?parseFloat(t.value):void 0},render:function(e){e!==parseFloat(t.value)&&(t.value="number"!=typeof e||k(e)?"":e)},listen:H(t,"input")})},default:function(t,e,n,r){r.push({node:t,token:n[0],path:n[2],pipe:n[3],read:function(){return t.value},render:function(e){e!==t.value&&(t.value="string"==typeof e?e:"")},listen:H(t,"input")})}},W=L(E("nodeType"),z),X=L(b.tag,R),J=L(E("type"),Y),K=L(E("type"),$)
h.types=z,h.tags=R,h.inputs=Y,h.mountAttribute=c,h.mountBoolean=s,h.mountInput=J,h.mountName=l,t.mount=h}(this),function(t){t.console&&t.console.log&&console.log("Sparky      - https://github.com/cruncher/sparky")}(this),function(t){"use strict"
function e(t,e){for(var n=[],r=-1;t[++r];)n.push(s(t[r],e))
return{stop:function(){return n.forEach(p("stop",arguments))},push:function(){return n.forEach(p("push",arguments))}}}function n(t){return t.replace(/\//g,"\\/")}function r(t,o,i){if(!r.prototype.isPrototypeOf(this))return new r(t,o,i)
if(t="string"==typeof t?document.querySelector(n(t)):t,"template"===E(t)){for(var s=F(t).cloneNode(!0),f=s.childNodes,l=-1;f[++l];)this[l]=f[l]
this.length=f.length,t=g(s)[0]}else this[0]=t,this.length=1
var d=i&&i.fn||c.attribute("data-fn",t)||"",p=!0,h=this,w=o?a.of(u(o)||o):a.of(),x=m
this.push=w.push,this.stop=function(){return w.stop&&w.stop(),x.stop&&x.stop(),h},this.interrupt=function(){return p=!1,{fn:d}}
for(var k,M,D;k=d.match(S);){if(M=r.fn[k[1]],!M)throw new Error('Sparky: fn "'+k[1]+'" not found in Sparky.fn')
if(D=k[2]&&JSON.parse("["+k[2].replace(/'/g,'"')+"]"),d=d.slice(k[0].length),w=M.call(this,t,w,D)||w,!p)return this}T.transforms=r.transforms,T.transformers=r.transformers
var L=i&&i.template||c.attribute("data-template",t)||""
L?w.take(1).each(function(n){var r=b(L)
if(!r)throw new Error('Sparky: data-template="'+L+'" not found in DOM')
y(t),v(t,r),x=e(h,T),x.push(n),w.each(x.push)}):(x=e(h,T),w.each(x.push))}var o=t.DEBUG,i=t.Fn,u=t.Observable,a=t.Stream,c=t.dom,s=t.mount,f=Object.assign,l=i.each,d=i.getPath,p=i.invoke,h=i.noop,m=i.nothing,v=c.append,g=c.children,y=c.empty,b=c.fragmentFromId,F=c.fragmentFromTemplate,w=c.preventDefault,x=c.remove,E=c.tag,S=/\s*([-\w]+)(?:\s*:\s*((?:"[^"]*"|'[^']*'|[\w-\[\]]*)(?:\s*,\s*(?:"[^"]*"|'[^']*'|[\w-\[\]]*))*))?/,T={mount:function(t){var e=c.attribute("data-fn",t),n=c.attribute("data-template",t)
if(e||n){var i=r(t,void 0,{fn:e,template:n})
return o&&console.log("mounted:",t,e,n),i.token=e,i.path="",i}}}
f(r.prototype,{push:h,remove:function(){return l(x,this),this}}),f(r,{fn:{scope:function(e,n,r){var o=d(r[0],t)
return o?i.of(d(r[0],t)):(console.warn("Sparky: no object at path "+r[0],data.cuts[110]),i.of())},get:function(t,e,n){return e.map(d(n[0]))},ignore:function(t,e){console.log(this.interrupt(),t,e)},prevent:function(t,e,n){t.addEventListener(n[0],w)},log:function(t,e){function n(e){console.group("Sparky: scope",t),console.log("data ",r.data),console.log("scope",e),console.log("fn   ",r.fn),console.groupEnd("---")}var r=this
return console.group("Sparky: run  ",t),console.log("data ",r.data),console.groupEnd("---"),e.tap(n)}},transforms:{},mount:s,MarkerNode:function(t){if(!o)return c.create("text","")
var e=t&&t.getAttribute("data-scope"),n=t&&t.getAttribute("data-fn")
return c.create("comment",(e?' data-scope="'+e+'"':"")+(n?' data-fn="'+n+'" ':""))}}),Object.defineProperties(r,{rtoken:{get:function(){return T.rtoken},set:function(t){T.rtoken=t},enumerable:!0,configurable:!0}}),t.Sparky=r}(this),Sparky.nodeToString=Fn.id,function(t){var e=t.Sparky
...
Sparky.scope=function(t){return console.warn("Sparky: Sparky.scope() deprecated in favour of Sparky.getScope()"),Sparky.getScope(t)},Sparky.setScope=function(e,n){if(!t.jQuery)throw new Error('data-fn="store-scope" requires jQuery.')
t.jQuery&&jQuery.data(e,"scope",n)},Sparky.getScope=function(e){if(!t.jQuery)throw new Error('data-fn="store-scope" requires jQuery.')
...
Sparky.fn["x-scroll-slave"]=function(t){function e(){t.scrollLeft=n.scrollLeft}var n,r=t.getAttribute("data-x-scroll-master")
...
n.addEventListener("scroll",e),e()}).on("destroy",function(){n&&n.removeEventListener("scroll",e)})},Sparky.fn["y-scroll-slave"]=function(t){function e(){t.scrollTop=r.scrollTop}var n=t.getAttribute("data-y-scroll-master"),r=document.getElementById(n)
if(!r)throw console.error(t),new Error('Sparky scroll-x-slave: id="'+n+'" not in the DOM.')
r.addEventListener("scroll",e),e(),this.on("destroy",function(){r.removeEventListener("scroll",e)})}}(),function(t){"use strict"
function e(t,e,n){var r=new a(t,e,n)
return r[p]=e,r}function n(t,n,r,o){for(var i,u,a,c=-1;++c<r.length;)if(u=r[c],i=o[c],!i||u!==i[p]){for(a=-1;o[++a]&&o[a][p]!==u;);i=a===o.length?e(s(t),u,n):o.splice(a,1)[0],o.splice(c,0,i)}}function r(t,e,n){for(;n.length>e.length;)n.pop().stop().remove()
for(var r=n.length,o=-1,i=t.parentNode;o<r;)for(t=t?t.nextSibling:null;++o<r&&n[o][0]!==t;)i.insertBefore(n[o][0],t)}var o=t.Fn,i=t.dom,u=t.Observable,a=t.Sparky,c=o.noop,s=i.clone,f=i.tag,l=u.observe,d=a.MarkerNode,p=Symbol("object")
a.fn.each=function(t,e,u){function a(t){var e=v?m.parentNode.value:void 0
n(p,h,t,s),r(m,t,s),v&&void 0!==e&&(m.parentNode.value=e)}var s=[],p=t.cloneNode(!0),h=this.interrupt(),m=d(t),v="option"===f(t),g=o.throttle(a,requestAnimationFrame,c)
p.removeAttribute("data-scope"),p.removeAttribute("data-fn"),i.before(t,m),i.remove(t)
var y=c,b=e.latest().shift()
b&&l(b,"",a),e.each(function(t){y(),y=l(t,"",g)})}}(this),function(t){"use strict"
