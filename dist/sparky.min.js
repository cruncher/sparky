...
o.lastIndex=0
var i=o.exec(r)
if(i)return K(t,e,i,n)}function d(t,e){var n=r(e.transforms,e.transformers,t.pipe),o=w(t.render,n),i=v.throttle(o,requestAnimationFrame,cancelAnimationFrame)
...
return{stop:function(){return n.forEach(d("stop",arguments))},push:function(){return n.forEach(d("push",arguments))}}}function n(t){return t.replace(/\//g,"\\/")}function r(t,o,i){if(!r.prototype.isPrototypeOf(this))return new r(t,o,i)
if(t="string"==typeof t?document.querySelector(n(t)):t,"template"===F(t)){for(var s=y(t).cloneNode(!0),f=s.childNodes,l=-1;f[++l];)this[l]=f[l]
this.length=f.length,t=m(s)[0]}else this[0]=t,this.length=1
var d=i&&i.fn||c.attribute("data-fn",t)||"",b=!0,E=this,S=this,T=p
a.call(this,function(t,e){this.shift=function(){var t
if(void 0!==o)return t=u(o),o=void 0,t},this.push=function(){o=arguments[arguments.length-1],t("push")},this.stop=function(){S.stop&&S.stop!==E.stop&&S.stop(),T.stop&&T.stop(),e(o?1:0)}}),this.interrupt=function(){return b=!1,{fn:d}}
for(var k,M,D;k=d.match(w);){if(M=r.fn[k[1]],!M)throw new Error('Sparky: fn "'+k[1]+'" not found in Sparky.fn')
if(D=k[2]&&JSON.parse("["+k[2].replace(/'/g,'"')+"]"),d=d.slice(k[0].length),S=M.call(this,t,S,D)||S,!b)return this}x.transforms=r.transforms,x.transformers=r.transformers
var L=i&&i.template||c.attribute("data-template",t)||""
L?S.take(1).each(function(n){var r=g(L)
if(!r)throw new Error('Sparky: data-template="'+L+'" not found in DOM')
v(t),h(t,r),T=e(E,x),T.push(n),S.each(T.push)}):(T=e(E,x),S.each(T.push))}var o=t.DEBUG,i=t.Fn,u=t.Observable,a=t.Stream,c=t.dom,s=t.mount,f=Object.assign,l=(i.each,i.getPath),d=i.invoke,p=(i.noop,i.nothing),h=c.append,m=c.children,v=c.empty,g=c.fragmentFromId,y=c.fragmentFromTemplate,b=c.preventDefault,F=(c.remove,c.tag),w=/\s*([-\w]+)(?:\s*:\s*((?:"[^"]*"|'[^']*'|[\w-\[\]]*)(?:\s*,\s*(?:"[^"]*"|'[^']*'|[\w-\[\]]*))*))?/,x={mount:function(t){var e=c.attribute("data-fn",t),n=c.attribute("data-template",t)
if(e||n){var i=r(t,void 0,{fn:e,template:n})
return o&&console.log("mounted:",t,e,n),i.token=e,i.path="",i}}}
r.prototype=Object.create(a.prototype),f(r,{fn:{scope:function(e,n,r){var o=l(r[0],t)
return o?i.of(l(r[0],t)):(console.warn("Sparky: no object at path "+r[0],data.cuts[110]),i.of())},get:function(t,e,n){return e.map(l(n[0]))},ignore:function(t,e){console.log(this.interrupt(),t,e)},prevent:function(t,e,n){t.addEventListener(n[0],b)},log:function(t,e){function n(e){console.group("Sparky: scope",t),console.log("data ",r.data),console.log("scope",e),console.log("fn   ",r.fn),console.groupEnd("---")}var r=this
...
return c.create("comment",(e?' data-scope="'+e+'"':"")+(n?' data-fn="'+n+'" ':""))}}),Object.defineProperties(r,{rtoken:{get:function(){return x.rtoken},set:function(t){x.rtoken=t},enumerable:!0,configurable:!0}}),t.Sparky=r}(this),Sparky.nodeToString=Fn.id,function(t){var e=t.Sparky
...
n(f,h,t,c),r(m,t,c),v&&void 0!==e&&(m.parentNode.value=e)}var c=[],f=t.cloneNode(!0),h=this.interrupt(),m=p(t),v="option"===l(t),g=o.throttle(a,requestAnimationFrame,s)
f.removeAttribute("data-scope"),f.removeAttribute("data-fn"),i.before(t,m),i.remove(t)
var y=s,b=e.latest().shift()
b&&d(b,"",a),e.each(function(t){y(),y=d(t,"",g)})}}(this),function(t){"use strict"
